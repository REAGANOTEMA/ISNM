<?php
$pageTitle = 'Contact Admissions Office';
...
.dept-card .dept-icon { width: 72px; height: 72px; border-radius: 50%; background: linear-gradient(135deg,#2563eb,#1d4ed8); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 30px; margin: 0 auto 16px; }
...
.dept-details i { width: 20px; color: #2563eb; }
...
<div class="dept-card">
<div class="dept-icon"><i class="fas fa-file-signature"></i></div>
<h2>Admissions Office</h2>
<p class="dept-subtitle">Get help with applications, enrollment, and admission requirements</p>
<div class="contact-btn-group">
<a href="mailto:admissions@igangaschoolofnursingandmidwifery.ac.ug" class="contact-btn email"><i class="fas fa-envelope"></i> admissions@igangaschool...</a>
<a href="https://wa.me/256772514889?text=Hello%20Admissions%20Office" target="_blank" class="contact-btn whatsapp"><i class="fab fa-whatsapp"></i> WhatsApp Admissions</a>
<a href="tel:+256772514889" class="contact-btn call"><i class="fas fa-phone"></i> Call Admissions</a>
</div>
<div class="dept-details">
<h4><i class="fas fa-info-circle me-2"></i>About the Admissions Office</h4>
<p><i class="fas fa-check-circle me-2"></i> We help with application processing, enrollment verification, and admission requirements.</p>
<p><i class="fas fa-clock me-2"></i> Office Hours: Mon-Fri, 8:00 AM - 5:00 PM</p>
<p><i class="fas fa-map-marker-alt me-2"></i> Located at the ISNM Main Campus, Iganga</p>
</div>
</div>
</div>
