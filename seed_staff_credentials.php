...
$staffAccounts = [
    ...
    ['email' => 'nursing-dep@igangaschoolofnursingandmidwifery.ac.ug',      'password' => 'isnm4life',     'full_name' => 'Head of Nursing',                'position' => 'Head of Nursing',                'department' => 'Nursing',            'role_name' => 'Head Nursing'],
    ['email' => 'midwifery-dep@igangaschoolofnursingandmidwifery.ac.ug',    'password' => 'Life2save',     'full_name' => 'Head of Midwifery',              'position' => 'Head of Midwifery',              'department' => 'Midwifery',           'role_name' => 'Head Midwifery'],
    ['email' => 'senior-lecturers@igangaschoolofnursingandmidwifery.ac.ug', 'password' => 'isnm2026',      'full_name' => 'Senior Lecturer',                'position' => 'Senior Lecturer',                'department' => 'Academic Affairs',    'role_name' => 'Senior Lecturers'],
    ['email' => 'lecturers@igangaschoolofnursingandmidwifery.ac.ug',        'password' => 'Isnm4life',     'full_name' => 'Lecturer',                       'position' => 'Lecturer',                       'department' => 'Academic Affairs',    'role_name' => 'Lecturers'],
    ...
    ['email' => 'matron@igangaschoolofnursingandmidwifery.ac.ug',           'password' => 'Isnm2026',      'full_name' => 'Matron',                         'position' => 'Matron',                         'department' => 'Student Welfare',   'role_name' => 'Matrons'],
    ['email' => 'warden@igangaschoolofnursingandmidwifery.ac.ug',           'password' => 'Lovely2God',    'full_name' => 'Warden',                         'position' => 'Warden',                         'department' => 'Student Welfare',   'role_name' => 'Wardens'],
    ['email' => 'sickbay@igangaschoolofnursingandmidwifery.ac.ug',          'password' => 'isnm2026',      'full_name' => 'Sickbay Nurse',                  'position' => 'Sickbay Nurse',                  'department' => 'Health Services',    'role_name' => 'Sickbay'],
    ['email' => 'guildpresident@igangaschoolofnursingandmidwifery.ac.ug',   'password' => 'isnm4life',     'full_name' => 'Guild President',                'position' => 'Guild President',                'department' => 'Student Leadership', 'role_name' => 'Guild President'],
    ...
    ['email' => 'skillslab@igangaschoolofnursingandmidwifery.ac.ug',        'password' => 'Lovely2God',    'full_name' => 'Skills Lab Manager',             'position' => 'Skills Lab Manager',             'department' => 'Skills Laboratory',  'role_name' => 'Skills Lab'],
    ['email' => 'skills-lab@igangaschoolofnursingandmidwifery.ac.ug',       'password' => 'Lovely2God',    'full_name' => 'Skills Lab Technician',          'position' => 'Skills Lab Technician',          'department' => 'Skills Laboratory',  'role_name' => 'Skills Lab'],
    ...
    ['email' => 'drivers@igangaschoolofnursingandmidwifery.ac.ug',          'password' => 'isnm4life',     'full_name' => 'Driver',                         'position' => 'Driver',                         'department' => 'Transport',         'role_name' => 'Drivers'],
    ['email' => 'security@igangaschoolofnursingandmidwifery.ac.ug',         'password' => 'safty1st',      'full_name' => 'Security Officer',               'position' => 'Security Officer',               'department' => 'Security',          'role_name' => 'Security'],
];
...
$requiredRoles = [
    ...
    'Head Nursing'                        => ['dashboards/head-nursing.php',         3],
    'Head Midwifery'                      => ['dashboards/head-midwifery.php',       3],
    'School Secretary'                    => ['dashboards/school-secretary.php',     4],
    'School Librarian'                    => ['dashboards/school-librarian.php',     4],
    'Senior Lecturers'                    => ['dashboards/senior-lecturers.php',     4],
    'Lecturers'                           => ['dashboards/lecturers.php',            4],
    'Matrons'                             => ['dashboards/matrons.php',              4],
    'Wardens'                             => ['dashboards/wardens.php',              4],
    'Sickbay'                             => ['dashboards/sickbay.php',              4],
    'Guild President'                     => ['dashboards/guild-president.php',      4],
    'Computer Lab Manager'                => ['dashboards/computer_lab.php',         4],
    'Skills Lab'                          => ['dashboards/skills-lab.php',           4],
    'Storekeeper'                         => ['dashboards/storekeeper.php',          5],
    'Drivers'                             => ['dashboards/drivers.php',              5],
    'Security'                            => ['dashboards/security.php',             5],
];
$rolesEnsured = 0;
