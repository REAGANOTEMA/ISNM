...
<title>Student Fees Portal – ISNM</title>
      ...
      <div class="card dev-card">
        <div class="card-header text-white">
          <div class="d-flex align-items-center gap-3 mb-1">
            ...
            <div>
              <h2 class="mb-1">Student Fees Portal</h2>
              <p class="mb-0 opacity-75">View fee structures, payment history, outstanding balances, and generate receipts</p>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <ul class="feature-list">
            <li><i class="fas fa-file-invoice text-primary"></i> View detailed fee structure by program and year</li>
            <li><i class="fas fa-credit-card text-success"></i> Online payment portal integration</li>
            <li><i class="fas fa-receipt text-warning"></i> Download payment receipts and statements</li>
            <li><i class="fas fa-balance-scale text-info"></i> Outstanding balance tracking with due alerts</li>
            <li><i class="fas fa-download text-secondary"></i> Export payment history for personal records</li>
          </ul>
          <hr class="my-4">
