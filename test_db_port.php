...
// Test staff database connection with port 3307
...
echo "Testing staff database connection...\n";
...
// Test students database connection with port 3307
...
echo "\nTesting students database connection...\n";
echo "Host: " . DB_HOST . "\n";
echo "Port: " . DB_PORT . "\n";
echo "User: " . DB_USER . "\n";
