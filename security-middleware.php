        ...
        if ($required_role) {
            ...
            if ($user_role !== $required_role_lower) {
                ...
                $role_categories = [
                    ...
                    'admin' => ['school principal', 'deputy principal', 'school secretary', 'academic registrar', 'hr manager', 'school librarian', 'matrons', 'wardens', 'lab technicians', 'sickbay', 'drivers', 'security', 'non-teaching staff'], // Sickbay covers legacy lab technicians too
