...
--
-- Host: localhost:3306
-- Generation Time: Jul 22, 2026 at 05:34 PM
...
CREATE DEFINER=`igangaschool`@`localhost` PROCEDURE `sp_school_statistics` ()   BEGIN
    SELECT
        ...
        (SELECT COUNT(*) FROM students WHERE YEAR(created_at) = YEAR(CURDATE())) AS new_this_year,
        (SELECT COALESCE(SUM(amount_received), 0) FROM payments WHERE status = 'completed' AND payment_date >= CURDATE()) AS revenue_today,
        (SELECT COALESCE(SUM(amount_received), 0) FROM payments WHERE status = 'completed' AND payment_date >= DATE_FORMAT(CURDATE(), '%Y-%m-01')) AS revenue_this_month,
        (SELECT COALESCE(SUM(amount), 0) FROM expenses WHERE status IN ('approved','paid') AND expense_date >= DATE_FORMAT(CURDATE(), '%Y-%m-01')) AS expenses_this_month,
        (SELECT COUNT(DISTINCT student_id) FROM student_requirements_status WHERE status = 'Verified') AS students_reqs_complete,
        (SELECT COUNT(DISTINCT student_id) FROM student_requirements_status WHERE status IN ('Not Submitted','Pending')) AS students_reqs_pending;
END$$

CREATE DEFINER=`igangaschool`@`localhost` PROCEDURE `sp_student_dashboard_summary` (IN `p_student_id` INT)   BEGIN
    SELECT
        s.id,
        s.student_number,
        s.full_name,
        ...
        COALESCE(fp.total_fees, 0) AS total_fees,
        COALESCE(fp.total_paid, 0) AS total_paid,
        COALESCE(fp.balance, 0) AS balance,
        fp.status AS fee_status,
        COALESCE(acad.gpa, NULL) AS current_gpa,
        acad.academic_standing,
        (SELECT COUNT(*) FROM student_requirements_status WHERE student_id = p_student_id AND status = 'Verified') AS reqs_verified,
        (SELECT COUNT(*) FROM student_requirements_status WHERE student_id = p_student_id) AS reqs_total,
        (SELECT COUNT(*) FROM student_documents WHERE student_id = p_student_id AND status = 'Active') AS docs_count
    FROM students s
    LEFT JOIN student_financial_profiles fp ON s.id = fp.student_id
    LEFT JOIN student_academic_profiles acad ON s.id = acad.student_id
    WHERE s.id = p_student_id;
END$$

CREATE DEFINER=`igangaschool`@`localhost` PROCEDURE `sp_student_fee_status` (IN `p_student_id` INT, IN `p_academic_year` VARCHAR(20))   BEGIN
    SELECT
        s.student_number,
        s.full_name,
        fp.*
    ...
    LEFT JOIN student_financial_profiles fp ON s.id = fp.student_id
    WHERE s.id = p_student_id
    AND (p_academic_year IS NULL OR fp.academic_year = p_academic_year);
...
INSERT INTO `admission_requirements` (`id`, `requirement_name`, `type`, `display_order`, `is_mandatory`, `is_active`, `created_at`) VALUES
(1, 'Birth Certificate', 'Certificate', 1, 1, 1, '2026-07-22 14:14:37'),
(2, 'Transfer Letter', 'Document', 2, 1, 1, '2026-07-22 14:14:37'),
(3, 'Passport Photos', 'Photo', 3, 1, 1, '2026-07-22 14:14:37'),
(4, 'Medical Form', 'Form', 4, 1, 1, '2026-07-22 14:14:37'),
(5, 'National ID', 'ID', 5, 0, 1, '2026-07-22 14:14:37'),
(6, 'Report Card', 'Document', 6, 1, 1, '2026-07-22 14:14:37'),
(7, 'Recommendation Letter', 'Document', 7, 0, 1, '2026-07-22 14:14:37'),
(8, 'Fee Receipt', 'Document', 8, 1, 1, '2026-07-22 14:14:37'),
(9, 'Registration Form', 'Form', 9, 1, 1, '2026-07-22 14:14:37'),
(10, 'Other Required Documents', 'Other', 10, 0, 1, '2026-07-22 14:14:37');
...
INSERT INTO `fee_structures` (`id`, `fee_name`, `fee_type`, `amount`, `program_id`, `program_name`, `academic_year`, `semester`, `level`, `is_mandatory`, `due_date`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Admission Fee', '', 150000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(2, 'Registration Fee', 'Registration', 100000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(3, 'Tuition Fee - Year 1', 'Tuition', 800000.00, NULL, NULL, '2026', NULL, 'Year 1', 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(4, 'Tuition Fee - Year 2', 'Tuition', 850000.00, NULL, NULL, '2026', NULL, 'Year 2', 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(5, 'Tuition Fee - Year 3', 'Tuition', 900000.00, NULL, NULL, '2026', NULL, 'Year 3', 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(6, 'Development Fee', '', 200000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(7, 'Uniform Fee', '', 150000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(8, 'Books & Materials Fee', '', 100000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(9, 'Transport Fee', '', 300000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(10, 'Meals Fee', '', 250000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(11, 'Hostel Fee', '', 400000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58'),
(12, 'Other Fees', 'Other', 50000.00, NULL, NULL, '2026', NULL, NULL, 1, NULL, 1, '2026-07-22 14:25:58', '2026-07-22 14:25:58');
...
CREATE TABLE `students` (
  ...
  `academic_year` varchar(20) DEFAULT NULL,
  `registration_status` enum('Pending','Registered','Completed') DEFAULT 'Pending',
...
INSERT INTO `students` (`id`, `student_number`, `registration_number`, `national_student_id_number`, `index_number`, `first_name`, `surname`, `other_name`, `full_name`, `email`, `password`, `phone`, `mobile_number`, `program`, `course`, `course_codes`, `current_year`, `year_of_study`, `year`, `level`, `set_name`, `current_semester`, `intake_date`, `date_of_birth`, `gender`, `nationality`, `address`, `district`, `emergency_contact_name`, `emergency_contact_phone`, `emergency_contact_email`, `sponsor`, `marital_status`, `religion`, `student_category`, `guardian_name`, `guardian_phone`, `guardian_email`, `profile_picture`, `passport_photo`, `status`, `last_login`, `locked_until`, `login_attempts`, `password_changed`, `is_first_login`, `created_at`, `updated_at`, `intake_year`, `intake_period`, `academic_year`, `registration_status`, `admission_date`, `graduation_date`, `transfer_date`, `transfer_reason`, `suspension_reason`, `suspended_at`, `activated_at`, `archived_at`, `stream`, `class_name`, `admission_number`, `national_id`, `county`, `sub_county`, `village`, `medical_conditions`, `blood_group`, `allergies`, `disability`, `previous_school`, `previous_qualification`, `guardian_relationship`, `hostel_required`, `transport_required`, `notes`) VALUES
(1, 'ISNM/0001/25', NULL, NULL, 'UACE/CNM/0001', 'Mary', 'Muwonge', NULL, 'Sarah Ssenyonjo', 'student1@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774571227', '+256-774571227', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(2, 'ISNM/0002/25', NULL, NULL, 'UACE/CNM/0002', 'Peace', 'Nakamya', NULL, 'Jane Ochieng', 'student2@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-776779291', '+256-776779291', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(3, 'ISNM/0003/25', NULL, NULL, 'UACE/CNM/0003', 'Moses', 'Okello', NULL, 'David Nanteza', 'student3@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-781279895', '+256-781279895', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(4, 'ISNM/0004/25', NULL, NULL, 'UACE/CNM/0004', 'Ruth', 'Sserwadda', NULL, 'Mary Ssenyonjo', 'student4@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-781236556', '+256-781236556', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(5, 'ISNM/0005/25', NULL, NULL, 'UACE/CNM/0005', 'Jane', 'Muwonge', NULL, 'John Okello', 'student5@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-775043713', '+256-775043713', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(6, 'ISNM/0006/25', NULL, NULL, 'UACE/CNM/0006', 'Esther', 'Nabirye', NULL, 'Mary Ochieng', 'student6@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-784260559', '+256-784260559', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Male', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(7, 'ISNM/0007/25', NULL, NULL, 'UACE/CNM/0007', 'Peace', 'Nabirye', NULL, 'Joy Nabirye', 'student7@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-703988337', '+256-703988337', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(8, 'ISNM/0008/25', NULL, NULL, 'UACE/CNM/0008', 'Faith', 'Namukwaya', NULL, 'Sarah Ssenyonjo', 'student8@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-703728063', '+256-703728063', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(9, 'ISNM/0009/25', NULL, NULL, 'UACE/CNM/0009', 'Esther', 'Nakamya', NULL, 'John Okello', 'student9@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-782284500', '+256-782284500', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(10, 'ISNM/0010/25', NULL, NULL, 'UACE/CNM/0010', 'David', 'Kintu', NULL, 'Alice Nanteza', 'student10@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-785019393', '+256-785019393', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(11, 'ISNM/0011/25', NULL, NULL, 'UACE/CNM/0011', 'Joy', 'Wasswa', NULL, 'Esther Nakato', 'student11@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-788356144', '+256-788356144', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 1, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(13, 'ISNM/0013/25', NULL, NULL, 'UACE/CNM/0013', 'John', 'Wasswa', NULL, 'Faith Nakamya', 'student13@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-778607555', '+256-778607555', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(14, 'ISNM/0014/25', NULL, NULL, 'UACE/CNM/0014', 'Peter', 'Mukasa', NULL, 'David Nanteza', 'student14@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-772111880', '+256-772111880', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(15, 'ISNM/0015/25', NULL, NULL, 'UACE/CNM/0015', 'Samuel', 'Wasswa', NULL, 'Mary Kizza', 'student15@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-780170078', '+256-780170078', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(16, 'ISNM/0016/25', NULL, NULL, 'UACE/CNM/0016', 'Samuel', 'Kizza', NULL, 'David Ochieng', 'student16@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-785312802', '+256-785312802', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(17, 'ISNM/0017/25', NULL, NULL, 'UACE/CNM/0017', 'Samuel', 'Lubega', NULL, 'Jane Nakato', 'student17@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774130995', '+256-774130995', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(18, 'ISNM/0018/25', NULL, NULL, 'UACE/CNM/0018', 'Esther', 'Ochieng', NULL, 'Grace Nakato', 'student18@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-707727624', '+256-707727624', 'Certificate in Midwifery', 'Certificate in Midwifery', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Male', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(19, 'ISNM/0019/25', NULL, NULL, 'UACE/CNM/0019', 'Mary', 'Muwonge', NULL, 'Grace Nabirye', 'student19@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256
isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-779129500', '+256-779129500', 'Certificate in Nursing', 'Certificate in Nursing', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(39, 'ISNM/0039/25', NULL, NULL, 'UACE/CNN/0039', 'Esther', 'Nabirye', NULL, 'Sarah Ssenyonjo', 'student39@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-775114752', '+256-775114752', 'Certificate in Nursing', 'Certificate in Nursing', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(40, 'ISNM/0040/25', NULL, NULL, 'UACE/CNN/0040', 'Alice', 'Kizza', NULL, 'Mary Okello', 'student40@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-772095035', '+256-772095035', 'Certificate in Nursing', 'Certificate in Nursing', NULL, 1, NULL, 1, 'Certificate', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(41, 'ISNM/0041/24', NULL, NULL, 'UACE/DNM/0041', 'Joy', 'Ssenyonjo', NULL, 'Esther Nakamya', 'student41@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-778993733', '+256-778993733', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(42, 'ISNM/0042/24', NULL, NULL, 'UACE/DNM/0042', 'Sarah', 'Ssenyonjo', NULL, 'Ruth Nakamya', 'student42@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-702057084', '+256-702057084', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Male', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(43, 'ISNM/0043/24', NULL, NULL, 'UACE/DNM/0043', 'David', 'Wasswa', NULL, 'Jane Nakamya', 'student43@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-789414023', '+256-789414023', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(44, 'ISNM/0044/24', NULL, NULL, 'UACE/DNM/0044', 'David', 'Lubega', NULL, 'John Mukasa', 'student44@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-771067107', '+256-771067107', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(45, 'ISNM/0045/24', NULL, NULL, 'UACE/DNM/0045', 'Samuel', 'Ochieng', NULL, 'Samuel Sserwadda', 'student45@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-778896965', '+256-778896965', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(46, 'ISNM/0046/24', NULL, NULL, 'UACE/DNM/0046', 'Peter', 'Mukasa', NULL, 'Grace Sserwadda', 'student46@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-787898635', '+256-787898635', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(47, 'ISNM/0047/24', NULL, NULL, 'UACE/DNM/0047', 'Sarah', 'Muwonge', NULL, 'Moses Nabirye', 'student47@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774581010', '+256-774581010', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(49, 'ISNM/0049/24', NULL, NULL, 'UACE/DNM/0049', 'Peter', 'Wasswa', NULL, 'Samuel Kintu', 'student49@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-704546145', '+256-704546145', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(51, 'ISNM/0051/24', NULL, NULL, 'UACE/DNM/0051', 'Ruth', 'Sserwadda', NULL, 'Esther Kizza', 'student51@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-784744390', '+256-784744390', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(52, 'ISNM/0052/24', NULL, NULL, 'UACE/DNM/0052', 'Peace', 'Lubega', NULL, 'Jane Sserwadda', 'student52@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-784913420', '+256-784913420', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(53, 'ISNM/0053/24', NULL, NULL, 'UACE/DNM/0053', 'Joy', 'Ochieng', NULL, 'Samuel Wasswa', 'student53@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-704965732', '+256-704965732', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(55, 'ISNM/0055/24', NULL, NULL, 'UACE/DNM/0055', 'Esther', 'Namukwaya', NULL, 'Jane Namukwaya', 'student55@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-786236264', '+256-786236264', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(56, 'ISNM/0056/24', NULL, NULL, 'UACE/DNM/0056', 'Ruth', 'Wasswa', NULL, 'Samuel Kintu', 'student56@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-703507071', '+256-703507071', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(58, 'ISNM/0058/24', NULL, NULL, 'UACE/DNM/0058', 'Peter', 'Mukasa', NULL, 'David Kintu', 'student58@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-773974868', '+256-773974868', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(60, 'ISNM/0060/24', NULL, NULL, 'UACE/DNM/0060', 'Joy', 'Namukwaya', NULL, 'Joy Ssenyonjo', 'student60@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-782151802', '+256-782151802', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Male', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(61, 'ISNM/0061/24', NULL, NULL, 'UACE/DNM/0061', 'Grace', 'Namukwaya', NULL, 'Jane Nakato', 'student61@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-770184003', '+256-770184003', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(62, 'ISNM/0062/24', NULL, NULL, 'UACE/DNM/0062', 'David', 'Nakato', NULL, 'Peter Nakamya', 'student62@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-708222949', '+256-708222949', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(63, 'ISNM/0063/24', NULL, NULL, 'UACE/DNM/0063', 'Jane', 'Nakamya', NULL, 'Sarah Nanteza', 'student63@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-705229417', '+256-705229417', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(64, 'ISNM/0064/24', NULL, NULL, 'UACE/DNM/0064', 'Moses', 'Nanteza', NULL, 'Grace Ochieng', 'student64@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-775654586', '+256-775654586', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(65, 'ISNM/0065/24', NULL, NULL, 'UACE/DNM/0065', 'Esther', 'Wasswa', NULL, 'Mary Kizza', 'student65@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-781748308', '+256-781748308', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(67, 'ISNM/0067/24', NULL, NULL, 'UACE/DNM/0067', 'Faith', 'Mukasa', NULL, 'Esther Lubega', 'student67@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-770387594', '+256-770387594', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(68, 'ISNM/0068/24', NULL, NULL, 'UACE/DNM/0068', 'Jane', 'Muwonge', NULL, 'John Mukasa', 'student68@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-771188826', '+256-771188826', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(69, 'ISNM/0069/24', NULL, NULL, 'UACE/DNM/0069', 'Samuel', 'Okello', NULL, 'Ruth Ochieng', 'student69@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-783249504', '+256-783249504', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(70, 'ISNM/0070/24', NULL, NULL, 'UACE/DNM/0070', 'Peace', 'Wasswa', NULL, 'Peter Kintu', 'student70@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-707752690', '+256-707752690', 'Diploma in Nursing', 'Diploma in Nursing', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(71, 'ISNM/0071/24', NULL, NULL, 'UACE/DMM/0071', 'David', 'Muwonge', NULL, 'Alice Lubega', 'student71@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-780560207', '+256-780560207', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL);
INSERT INTO `students` (`id`, `student_number`, `registration_number`, `national_student_id_number`, `index_number`, `first_name`, `surname`, `other_name`, `full_name`, `email`, `password`, `phone`, `mobile_number`, `program`, `course`, `course_codes`, `current_year`, `year_of_study`, `year`, `level`, `set_name`, `current_semester`, `intake_date`, `date_of_birth`, `gender`, `nationality`, `address`, `district`, `emergency_contact_name`, `emergency_contact_phone`, `emergency_contact_email`, `sponsor`, `marital_status`, `religion`, `student_category`, `guardian_name`, `guardian_phone`, `guardian_email`, `profile_picture`, `passport_photo`, `status`, `last_login`, `locked_until`, `login_attempts`, `password_changed`, `is_first_login`, `created_at`, `updated_at`, `intake_year`, `intake_period`, `academic_year`, `registration_status`, `admission_date`, `graduation_date`, `transfer_date`, `transfer_reason`, `suspension_reason`, `suspended_at`, `activated_at`, `archived_at`, `stream`, `class_name`, `admission_number`, `national_id`, `county`, `sub_county`, `village`, `medical_conditions`, `blood_group`, `allergies`, `disability`, `previous_school`, `previous_qualification`, `guardian_relationship`, `hostel_required`, `transport_required`, `notes`) VALUES
...
(73, 'ISNM/0073/24', NULL, NULL, 'UACE/DMM/0073', 'Peace', 'Okello', NULL, 'Mary Sserwadda', 'student73@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-777382056', '+256-777382056', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(74, 'ISNM/0074/24', NULL, NULL, 'UACE/DMM/0074', 'Grace', 'Namukwaya', NULL, 'Peace Sserwadda', 'student74@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774208337', '+256-774208337', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(75, 'ISNM/0075/24', NULL, NULL, 'UACE/DMM/0075', 'Esther', 'Sserwadda', NULL, 'Samuel Nakamya', 'student75@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774107687', '+256-774107687', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(76, 'ISNM/0076/24', NULL, NULL, 'UACE/DMM/0076', 'Faith', 'Nakamya', NULL, 'Faith Muwonge', 'student76@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-786791936', '+256-786791936', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(77, 'ISNM/0077/24', NULL, NULL, 'UACE/DMM/0077', 'Mary', 'Ssenyonjo', NULL, 'David Kizza', 'student77@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-780318876', '+256-780318876', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(79, 'ISNM/0079/24', NULL, NULL, 'UACE/DMM/0079', 'Mary', 'Kintu', NULL, 'Esther Kintu', 'student79@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-704378691', '+256-704378691', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(80, 'ISNM/0080/24', NULL, NULL, 'UACE/DMM/0080', 'John', 'Ochieng', NULL, 'Peter Ssenyonjo', 'student80@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-770329121', '+256-770329121', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(81, 'ISNM/0081/24', NULL, NULL, 'UACE/DMM/0081', 'Faith', 'Namukwaya', NULL, 'Mary Ochieng', 'student81@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-780482903', '+256-780482903', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(82, 'ISNM/0082/24', NULL, NULL, 'UACE/DMM/0082', 'Alice', 'Kintu', NULL, 'Peace Nakato', 'student82@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-775910832', '+256-775910832', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(83, 'ISNM/0083/24', NULL, NULL, 'UACE/DMM/0083', 'Peace', 'Muwonge', NULL, 'Peter Kizza', 'student83@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-779177049', '+256-779177049', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(85, 'ISNM/0085/24', NULL, NULL, 'UACE/DMM/0085', 'Peace', 'Sserwadda', NULL, 'Mary Muwonge', 'student85@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-700702837', '+256-700702837', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(86, 'ISNM/0086/24', NULL, NULL, 'UACE/DMM/0086', 'Moses', 'Nabirye', NULL, 'Ruth Namukwaya', 'student86@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-705633283', '+256-705633283', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(87, 'ISNM/0087/24', NULL, NULL, 'UACE/DMM/0087', 'Grace', 'Nabirye', NULL, 'Mary Muwonge', 'student87@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-709698010', '+256-709698010', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(88, 'ISNM/0088/24', NULL, NULL, 'UACE/DMM/0088', 'Alice', 'Nabirye', NULL, 'Grace Namukwaya', 'student88@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774207258', '+256-774207258', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(89, 'ISNM/0089/24', NULL, NULL, 'UACE/DMM/0089', 'Alice', 'Namukwaya', NULL, 'Alice Muwonge', 'student89@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-779644139', '+256-779644139', 'Diploma in Midwifery', 'Diploma in Midwifery', NULL, 2, NULL, 2, 'Diploma', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(91, 'ISNM/0091/23', NULL, NULL, 'UACE/DNE/0091', 'Peter', 'Kintu', NULL, 'Sarah Nanteza', 'student91@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-707456515', '+256-707456515', 'Diploma in Nursing Education', 'Diploma in Nursing Education', NULL, 3, NULL, 3, 'Degree', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Bugiri', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(93, 'ISNM/0093/23', NULL, NULL, 'UACE/DNE/0093', 'John', 'Namukwaya', NULL, 'Peace Okello', 'student93@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-706268467', '+256-706268467', 'Diploma in Nursing Education', 'Diploma in Nursing Education', NULL, 3, NULL, 3, 'Degree', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Iganga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(94, 'ISNM/0094/23', NULL, NULL, 'UACE/DNE/0094', 'Grace', 'Ssenyonjo', NULL, 'Grace Ssenyonjo', 'student94@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-707729037', '+256-707729037', 'Diploma in Nursing Education', 'Diploma in Nursing Education', NULL, 3, NULL, 3, 'Degree', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Mayuge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(100, 'ISNM/0100/23', NULL, NULL, 'UACE/DNE/0100', 'Moses', 'Namukwaya', NULL, 'John Namukwaya', 'student100@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-777276039', '+256-777276039', 'Diploma in Nursing Education', 'Diploma in Nursing Education', NULL, 3, NULL, 3, 'Degree', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Kamuli', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(103, 'ISNM/0103/23', NULL, NULL, 'UACE/DNE/0103', 'Peace', 'Nanteza', NULL, 'Jane Nabirye', 'student103@isnm.ac.ug', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '+256-774669700', '+256-774669700', 'Diploma in Nursing Education', 'Diploma in Nursing Education', NULL, 3, NULL, 3, 'Degree', NULL, NULL, NULL, NULL, 'Female', 'Ugandan', 'Jinja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 0, 1, '2026-07-03 04:51:13', '2026-07-16 19:52:40', NULL, 'July', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(151, 'STU202600001', 'REG-2026-001', NULL, 'CM-2026-001', 'John', 'Okello', 'James', 'John James Okello', 'john.okello@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000001', '0770000001', 'Bachelor of Science in Nursing (Comprehensive)', 'BSc Nursing', NULL, 1, NULL, 1, 'Year 1', '1', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:52:40', '2026-07-16 19:52:40', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(152, 'STU202600002', 'REG-2026-002', NULL, 'MID-2026-001', 'Grace', 'Nambi', '', 'Grace Nambi', 'grace.nambi@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000002', '0770000002', 'Bachelor of Science in Midwifery', 'BSc Midwifery', NULL, 1, NULL, 1, 'Year 1', '2', NULL, '2026-01-15', NULL, 'Female', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:52:40', '2026-07-16 19:52:40', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
(154, 'STU202600001', 'REG-2026-001', NULL, 'CM-2026-001', 'John', 'Okello', 'James', 'John James Okello', 'john.okello@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000001', '0770000001', 'Bachelor of Science in Nursing (Comprehensive)', 'BSc Nursing', NULL, 1, NULL, 1, 'Year 1', '1', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:52:51', '2026-07-16 19:52:51', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(155, 'STU202600002', 'REG-2026-002', NULL, 'MID-2026-001', 'Grace', 'Nambi', '', 'Grace Nambi', 'grace.nambi@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000002', '0770000002', 'Bachelor of Science in Midwifery', 'BSc Midwifery', NULL, 1, NULL, 1, 'Year 1', '2', NULL, '2026-01-15', NULL, 'Female', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:52:51', '2026-07-16 19:52:51', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(156, 'STU202600003', 'REG-2026-003', NULL, 'DIP-2026-001', 'Samuel', 'Mugisha', 'Peter', 'Samuel Peter Mugisha', 'samuel.mugisha@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000003', '0770000003', 'Diploma in Nursing/Midwifery', 'Dip Nursing', NULL, 1, NULL, 1, 'Year 1', '3', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:52:51', '2026-07-16 19:52:51', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(157, 'STU202600001', 'REG-2026-001', NULL, 'CM-2026-001', 'John', 'Okello', 'James', 'John James Okello', 'john.okello@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000001', '0770000001', 'Bachelor of Science in Nursing (Comprehensive)', 'BSc Nursing', NULL, 1, NULL, 1, 'Year 1', '1', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:53:02', '2026-07-16 19:53:02', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(158, 'STU202600002', 'REG-2026-002', NULL, 'MID-2026-001', 'Grace', 'Nambi', '', 'Grace Nambi', 'grace.nambi@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000002', '0770000002', 'Bachelor of Science in Midwifery', 'BSc Midwifery', NULL, 1, NULL, 1, 'Year 1', '2', NULL, '2026-01-15', NULL, 'Female', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:53:02', '2026-07-16 19:53:02', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(159, 'STU202600003', 'REG-2026-003', NULL, 'DIP-2026-001', 'Samuel', 'Mugisha', 'Peter', 'Samuel Peter Mugisha', 'samuel.mugisha@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000003', '0770000003', 'Diploma in Nursing/Midwifery', 'Dip Nursing', NULL, 1, NULL, 1, 'Year 1', '3', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:53:02', '2026-07-16 19:53:02', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(160, 'STU202600001', 'REG-2026-001', NULL, 'CM-2026-001', 'John', 'Okello', 'James', 'John James Okello', 'john.okello@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000001', '0770000001', 'Bachelor of Science in Nursing (Comprehensive)', 'BSc Nursing', NULL, 1, NULL, 1, 'Year 1', '1', NULL, '2026-01-15', NULL, 'Male', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:53:14', '2026-07-16 19:53:14', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
(161, 'STU202600002', 'REG-2026-002', NULL, 'MID-2026-001', 'Grace', 'Nambi', '', 'Grace Nambi', 'grace.nambi@student.isnm.ac.ug', '$2y$10$HxVkw2ihQPBwiK/fXa9Lqezmnw8KmKVSOMVGXfUynT09hDxYbadQe', '0770000002', '0770000002', 'Bachelor of Science in Midwifery', 'BSc Midwifery', NULL, 1, NULL, 1, 'Year 1', '2', NULL, '2026-01-15', NULL, 'Female', 'Ugandan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', NULL, NULL, 0, 1, 0, '2026-07-16 19:53:14', '2026-07-16 19:53:14', '2026', 'January', NULL, 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, NULL),
...
INSERT INTO `student_academic_profiles` (`id`, `student_number`, `full_name`, `program`, `academic_year`, `semester`, `status`, `gpa`, `remarks`, `created_at`, `updated_at`, `student_id`, `current_program`, `current_year`, `current_semester`, `cumulative_gpa`, `total_credits`, `earned_credits`, `academic_standing`, `advisor_name`, `advisor_email`) VALUES
(1, 'STU202644246', 'Daniel Kizza', 'Diploma in Nursing', '2026', NULL, 'Active', NULL, NULL, '2026-07-05 17:36:37', '2026-07-05 17:36:37', 0, NULL, 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(2, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 1, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(3, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 2, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(4, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 3, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(5, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 4, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(6, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 5, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(7, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 6, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(8, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 7, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(9, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 8, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(10, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 9, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(11, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 10, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(12, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 11, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(13, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 12, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(14, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 13, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(15, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 14, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(16, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 15, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(17, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 16, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(18, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 17, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(19, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 18, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(20, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 19, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(21, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 20, 'Certificate in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(22, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 21, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(23, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 22, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(24, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 23, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(25, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 24, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(26, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 25, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(27, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 26, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(28, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 27, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(29, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 28, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(30, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 29, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(31, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 30, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(32, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 31, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(33, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 32, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(34, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 33, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(35, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 34, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(36, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 35, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(37, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 36, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(38, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 37, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(39, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 38, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(40, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 39, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(41, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 40, 'Certificate in Nursing', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(42, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 41, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(43, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 42, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(44, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 43, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(45, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 44, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(46, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 45, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(47, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 46, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(48, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 47, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(49, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 48, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(50, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 49, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(51, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 50, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(52, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 51, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(53, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 52, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(54, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 53, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(55, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 54, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(56, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 55, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(57, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 56, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(58, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 57, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(59, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 58, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(60, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 59, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(61, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 60, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(62, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 61, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(63, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 62, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(64, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 63, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(65, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 64, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(66, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 65, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(67, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 66, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(68, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 67, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(69, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 68, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(70, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 69, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(71, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 70, 'Diploma in Nursing', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(72, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 71, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(73, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 72, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(74, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 73, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(75, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 74, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(76, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 75, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(77, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 76, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(78, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 77, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(79, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 78, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(80, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 79, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(81, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 80, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(82, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 81, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(83, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 82, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(84, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 83, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(85, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 84, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(86, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 85, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(87, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 86, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(88, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 87, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(89, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 88, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(90, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 89, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(91, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 90, 'Diploma in Midwifery', 2, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(92, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 91, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(93, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 92, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(94, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 93, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(95, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 94, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(96, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 95, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(97, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 96, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(98, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 97, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(99, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 98, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(100, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 99, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(101, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 100, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(102, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 101, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(103, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 102, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(104, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 103, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(105, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 104, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(106, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 105, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(107, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 106, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(108, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 107, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(109, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 108, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(110, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 109, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(111, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 110, 'Diploma in Nursing Education', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(112, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 111, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(113, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 112, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(114, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 113, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(115, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 114, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(116, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 115, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(117, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 116, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(118, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 117, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(119, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 118, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(120, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 119, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(121, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 120, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(122, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 121, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(123, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 122, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(124, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 123, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(125, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 124, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(126, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 125, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(127, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 126, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(128, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 127, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(129, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 128, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(130, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 129, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(131, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 130, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(132, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 131, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(133, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 132, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(134, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 133, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(135, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 134, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(136, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 135, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(137, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 136, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(138, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 137, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(139, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 138, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(140, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 139, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(141, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 140, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(142, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 141, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(143, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 142, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(144, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 143, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(145, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 144, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(146, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 145, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(147, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 146, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(148, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 147, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(149, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 148, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(150, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 149, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(151, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 150, 'Bachelor of Science in Nursing', 3, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(152, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 151, 'Bachelor of Science in Nursing (Comprehensive)', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(153, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 152, 'Bachelor of Science in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(154, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 153, 'Diploma in Nursing/Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(155, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 154, 'Bachelor of Science in Nursing (Comprehensive)', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(156, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 155, 'Bachelor of Science in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(157, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 156, 'Diploma in Nursing/Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(158, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 157, 'Bachelor of Science in Nursing (Comprehensive)', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(159, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 158, 'Bachelor of Science in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(160, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 159, 'Diploma in Nursing/Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(161, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 160, 'Bachelor of Science in Nursing (Comprehensive)', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(162, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 161, 'Bachelor of Science in Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL),
(163, '', '', NULL, NULL, NULL, 'Active', NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45', 162, 'Diploma in Nursing/Midwifery', 1, NULL, NULL, 0, 0, 'Good Standing', NULL, NULL);
...
--
-- Dumping data for table `student_attendance_profiles`
--

INSERT INTO `student_attendance_profiles` (`id`, `student_id`, `academic_year`, `semester`, `total_days`, `days_present`, `days_absent`, `days_excused`, `attendance_rate`, `created_at`, `updated_at`) VALUES
(1, 1, '2026', 'Semester 2', 0, 0, 0, 0, 0.00, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(74, 74, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(75, 75, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(76, 76, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(77, 77, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(78, 78, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(79, 79, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(80, 80, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(81, 81, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(82, 82, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(83, 83, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(84, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(85, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(86, 86, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(87, 87, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(88, 88, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(89, 89, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(90, 90, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(91, 91, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(92, 92, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(93, 93, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(94, 94, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(95, 95, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(96, 96, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(97, 97, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(98, 98, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(99, 99, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(100, 100, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(101, 101, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(102, 102, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(103, 103, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(104, 104, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(105, 105, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(106, 106, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(107, 107, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(108, 108, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(109, 109, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(110, 110, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(111, 111, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(112, 112, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(113, 113, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(114, 114, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(115, 115, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(116, 116, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(117, 117, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(118, 118, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(119, 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(120, 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(121, 121, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(122, 122, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(123, 123, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(124, 124, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(125, 125, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(126, 126, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(127, 127, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(128, 128, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(129, 129, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(130, 130, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(131, 131, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(132, 132, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(133, 133, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(134, 134, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(135, 135, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(136, 136, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(137, 137, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(138, 138, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(139, 139, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(140, 140, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(141, 141, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(142, 142, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(143, 143, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(144, 144, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(145, 145, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(146, 146, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(147, 147, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(148, 148, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(149, 149, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(150, 150, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(151, 151, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(152, 152, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(153, 153, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(154, 154, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(155, 155, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(156, 156, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(157, 157, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(158, 158, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(159, 159, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(160, 160, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(161, 161, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45'),
(162, 162, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2026-07-22 14:33:45', '2026-07-22 14:33:45');
...
--
-- Stand-in structure for view `v_requirements_overview`
-- (See below for the actual view)
--
...
,`verified_count` decimal(23,0)
,`pending_count` decimal(23,0)
,`completion_percentage` decimal(28,1)
);
...
,`current_year` int(11)
,`status` enum('Active','Inactive','Graduated','Suspended','Withdrawn','deleted')
,`registration_status` enum('Pending','Registered','Completed')
...
,`fee_balance` decimal(14,2)
,`fee_status` enum('pending','partial','paid','overdue')
,`created_at` timestamp
);
...
ALTER TABLE `payment_history`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_ph_ref` (`payment_reference`),
  ADD KEY `idx_ph_student` (`student_id`),
  ADD KEY `idx_ph_date` (`payment_date`),
  ADD KEY `idx_ph_fee_type` (`fee_type`),
  ADD KEY `idx_ph_status` (`status`),
  ADD KEY `idx_ph_year` (`academic_year`);
...
ALTER TABLE `students`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_admission_number` (`admission_number`),
  ...
  ADD KEY `idx_stu_surname` (`surname`),
  ADD KEY `idx_stu_district` (`district`),
  ADD KEY `idx_stu_guardian` (`guardian_name`),
  ADD KEY `idx_stu_religion` (`religion`),
  ADD KEY `idx_stu_stream` (`stream`),
  ADD KEY `idx_stu_class` (`class_name`),
  ADD KEY `idx_stu_fullname` (`full_name`(100));
...
ALTER TABLE `student_accounts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_sa_student` (`student_id`),
  ADD UNIQUE KEY `uniq_sa_username` (`username`),
  ADD KEY `idx_sa_student` (`student_id`),
  ADD KEY `idx_sa_username` (`username`);
...
--
-- Indexes for table `student_attendance_profiles`
--
ALTER TABLE `student_attendance_profiles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_sap2_student_year_sem` (`student_id`,`academic_year`,`semester`),
  ADD KEY `idx_sap2_student` (`student_id`);
...
--
-- Indexes for table `student_library_profiles`
--
ALTER TABLE `student_library_profiles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_slp_student` (`student_id`),
...
ALTER TABLE `student_medical_profiles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_smp_student` (`student_id`),
  ADD KEY `idx_smp_student` (`student_id`);
...
--
-- AUTO_INCREMENT for table `student_attendance_profiles`
--
ALTER TABLE `student_attendance_profiles`
...
--
-- AUTO_INCREMENT for table `student_library_profiles`
--
ALTER TABLE `student_library_profiles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`igangaschool`@`localhost` SQL SECURITY DEFINER VIEW `v_payment_summary`  AS SELECT `p`.`id` AS `id`, `p`.`payment_reference` AS `payment_reference`, `p`.`student_id` AS `student_id`, `s`.`student_number` AS `student_number`, `s`.`full_name` AS `student_name`, `p`.`amount_received` AS `amount_received`, `p`.`payment_method` AS `payment_method`, `p`.`payment_date` AS `payment_date`, `p`.`status` AS `status`, `p`.`received_by` AS `received_by` FROM (`payments` `p` join `students` `s` on(`p`.`student_id` = `s`.`id`)) ;

-- --------------------------------------------------------

--
-- Structure for view `v_requirements_overview`
--
DROP TABLE IF EXISTS `v_requirements_overview`;

CREATE ALGORITHM=UNDEFINED DEFINER=`igangaschool`@`localhost` SQL SECURITY DEFINER VIEW `v_requirements_overview`  AS SELECT `s`.`id` AS `student_id`, `s`.`student_number` AS `student_number`, `s`.`full_name` AS `full_name`, count(`srs`.`id`) AS `total_requirements`, sum(case when `srs`.`status` = 'Verified' then 1 else 0 end) AS `verified_count`, sum(case when `srs`.`status` in ('Not Submitted','Pending') then 1 else 0 end) AS `pending_count`, round(case when count(`srs`.`id`) > 0 then sum(case when `srs`.`status` = 'Verified' then 1 else 0 end) / count(`srs`.`id`) * 100 else 0 end,1) AS `completion_percentage` FROM (`students` `s` left join `student_requirements_status` `srs` on(`s`.`id` = `srs`.`student_id`)) WHERE `s`.`status` <> 'deleted' GROUP BY `s`.`id`, `s`.`student_number`, `s`.`full_name` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`igangaschool`@`localhost` SQL SECURITY DEFINER VIEW `v_student_summary`  AS SELECT `s`.`id` AS `id`, `s`.`student_number` AS `student_number`, `s`.`admission_number` AS `admission_number`, `s`.`first_name` AS `first_name`, `s`.`surname` AS `surname`, `s`.`other_name` AS `other_name`, `s`.`full_name` AS `full_name`, `s`.`gender` AS `gender`, `s`.`phone` AS `phone`, `s`.`email` AS `email`, `s`.`program` AS `program`, `s`.`level` AS `level`, `s`.`current_year` AS `current_year`, `s`.`status` AS `status`, `s`.`registration_status` AS `registration_status`, `s`.`district` AS `district`, `s`.`religion` AS `religion`, `s`.`stream` AS `stream`, `s`.`class_name` AS `class_name`, `s`.`academic_year` AS `academic_year`, `s`.`intake_year` AS `intake_year`, `s`.`intake_period` AS `intake_period`, coalesce(`fp`.`total_fees`,0) AS `total_fees`, coalesce(`fp`.`total_paid`,0) AS `total_paid`, coalesce(`fp`.`balance`,0) AS `fee_balance`, `fp`.`status` AS `fee_status`, `s`.`created_at` AS `created_at` FROM (`students` `s` left join `student_financial_profiles` `fp` on(`s`.`id` = `fp`.`student_id`)) WHERE `s`.`status` <> 'deleted' ;
