...
-- Student requests (leave, deferral, etc.)
...
-- Department requests (any dept can request to HR/Store)
...
SELECT 'Students DB supplement tables ready.' AS status;
