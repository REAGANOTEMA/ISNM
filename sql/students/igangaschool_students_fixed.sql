...
DELIMITER ;;
CREATE DEFINER=`igangaschool`@`localhost` PROCEDURE `AddColIfMissing`(IN `p_schema` VARCHAR(255), IN `p_table` VARCHAR(255), IN `p_col` VARCHAR(255), IN `p_def` TEXT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`igangaschool`@`localhost` PROCEDURE `MigratePayroll`()
BEGIN
...
/*!50013 DEFINER=`igangaschool`@`localhost` SQL SECURITY INVOKER */
