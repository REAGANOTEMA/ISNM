-- ============================================================
-- ISNM PAYMENT GATEWAY — DATABASE SETUP
-- Run this to create/verify all payment gateway tables.
...
-- ============================================================
-- 1. payment_gateway_settings — key-value provider config
-- ============================================================
...
-- ============================================================
-- 2. payment_providers — provider configurations
-- ============================================================
...
-- ============================================================
-- 3. payment_transactions — every payment attempt
-- ============================================================
...
-- ============================================================
-- 4. payment_callbacks — raw callback/webhook logs
-- ============================================================
...
-- ============================================================
-- 5. payment_refunds — refund tracking
-- ============================================================
...
-- ============================================================
-- 6. payment_reconciliation — daily reconciliation records
-- ============================================================
...
-- ============================================================
-- 7. payment_webhook_logs — detailed webhook processing logs
-- ============================================================
...
-- ============================================================
-- 8. payment_receipts — auto-generated receipts
-- ============================================================
...
-- ============================================================
-- 9. payment_audit_log — all payment-related actions
-- ============================================================
...
INSERT IGNORE INTO `payment_providers`
  (`provider_key`, `provider_name`, `provider_type`, `provider_category`, `description`, `currency`, `status`, `is_test_mode`, `sort_order`,
   `api_base_url`, `test_api_base_url`)
VALUES
  ('mtn_momo', 'MTN Mobile Money', 'mobile_money', 'mobile_money',
   'MTN MoMo mobile money payments for Uganda',
   'UGX', 'inactive', 1, 1,
   'https://proxy.momoapi.mtn.com', 'https://sandbox.momodeveloper.mtn.com'),

  ('airtel_money', 'Airtel Money', 'mobile_money', 'mobile_money',
   'Airtel Money mobile payments for Uganda',
   'UGX', 'inactive', 1, 2,
   'https://openapi.airtel.ug', 'https://openapi.airtel.ug/sandbox'),

  ('stripe', 'Stripe', 'card_gateway', 'international',
   'Stripe - International card payments (Visa, Mastercard, AMEX)',
   'USD', 'inactive', 1, 3,
   'https://api.stripe.com/v1', 'https://api.stripe.com/v1'),

  ('flutterwave', 'Flutterwave', 'card_gateway', 'international',
   'Flutterwave - Cards, Mobile Money, Bank across Africa',
   'UGX', 'inactive', 1, 4,
   'https://api.flutterwave.com', 'https://api.flutterwave.com'),

  ('pesapal', 'PesaPal', 'card_gateway', 'local',
   'PesaPal - Cards and Mobile Money in East Africa',
   'UGX', 'inactive', 1, 5,
   'https://www.pesapal.com/api', 'https://www.pesapal.com/api'),
  ...
  ('direct_bank', 'Direct Bank Transfer', 'bank_transfer', 'bank',
   'Manual bank transfer with proof-of-payment verification',
   'UGX', 'active', 0, 7,
   NULL, NULL);

-- ============================================================
-- SEED DATA: Default Gateway Settings
-- ============================================================
INSERT IGNORE INTO `payment_gateway_settings` (`setting_key`, `setting_value`, `setting_group`, `description`) VALUES
  ('gateway_enabled', '1', 'general', 'Master switch for the payment gateway'),
  ('default_currency', 'UGX', 'general', 'Default payment currency'),
  ('payment_timeout_minutes', '30', 'general', 'Minutes before a pending payment expires'),
  ('auto_verify_enabled', '1', 'general', 'Automatically verify pending payments via cron'),
  ('receipt_prefix', 'ISNM', 'receipts', 'Prefix for receipt numbers'),
  ('receipt_starting_number', '10001', 'receipts', 'Starting receipt sequence number'),
  ('notification_email', 'finance@isnm.ac.ug', 'notifications', 'Email for payment notifications'),
  ('callback_base_url', '', 'webhooks', 'Base URL for payment callbacks (e.g. https://isnm.ac.ug)'),
  ('bank_name', 'Stanbic Bank Uganda', 'bank_transfer', 'Bank name for transfers'),
  ('bank_account_name', 'Iganga School of Nursing and Midwifery', 'bank_transfer', 'Account name'),
  ('bank_account_number', '', 'bank_transfer', 'Bank account number'),
  ('bank_swift_code', '', 'bank_transfer', 'SWIFT/BIC code'),
  ('bank_branch', 'Iganga', 'bank_transfer', 'Bank branch');
