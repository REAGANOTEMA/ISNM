...
('PRINC001', 'School Principal', 'principal@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$principal@isnmHashedPassword', '+256701000006', 'School Principal', 'Academic Affairs',
 (SELECT id FROM staff_roles WHERE role_name = 'School Principal' LIMIT 1), 'Active', CURDATE(), FALSE, TRUE, NOW()),

-- Deputy Principal
('DEPUT001', 'Deputy Principal', 'deputy_principal@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$deputy_principal@isnmHashedPassword', '+256701000007', 'Deputy Principal', 'Academic Affairs',
...
('DA001', 'Director Admissions & Requirements', 'admissions@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$admissions@isnmHashedPassword', '+256701000009', 'Director Admissions & Requirements', 'Academic Affairs',
...
('SEC001', 'School Secretary', 'secretary@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$secretary@isnmHashedPassword', '+256701000012', 'School Secretary', 'Administrative Support',
...
-- Senior Lecturers
('SL001', 'Senior Lecturer', 'senior_lecturers@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$senior_lecturers@isnmHashedPassword', '+256701000016', 'Senior Lecturers', 'Academic Affairs',
...
('LEC001', 'Lecturer', 'lecturers@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$lecturers@isnmHashedPassword', '+256701000017', 'Lecturers', 'Academic Affairs',
...
('LAB001', 'Lab Technician', 'lab@igangaschoolofnursingandmidwifery.ac.ug',
 ...
 (SELECT id FROM staff_roles WHERE role_name = 'Lab Technicians' LIMIT 1), 'Active', CURDATE(), FALSE, TRUE, NOW()),

-- Drivers
('DRV001', 'Driver', 'drivers@igangaschoolofnursingandmidwifery.ac.ug',
 '$2y$10$drivers@isnmHashedPassword', '+256701000021', 'Drivers', 'Support',
