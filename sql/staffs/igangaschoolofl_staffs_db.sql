...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2026 at 12:30 PM
...
INSERT IGNORE INTO `academic_calendar` (`id`, `calendar_id`, `academic_year`, `semester`, `semester_start_date`, `semester_end_date`, `exam_start_date`, `exam_end_date`, `result_publication_date`, `registration_deadline`, `add_drop_deadline`, `withdrawal_deadline`, `status`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `academic_programs` (`id`, `program_code`, `program_name`, `program_type`, `department`, `duration_years`, `total_credits`, `program_coordinator`, `accreditation_status`, `accreditation_body`, `accreditation_expiry`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `admission_requirements` (`id`, `requirement_name`, `description`, `is_active`, `display_order`, `created_at`) VALUES
...
INSERT IGNORE INTO `appraisal_periods` (`id`, `period_name`, `period_code`, `start_date`, `end_date`, `review_deadline`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `approval_stages` (`id`, `workflow_id`, `stage_order`, `stage_name`, `stage_code`, `assigned_role_id`, `assigned_staff_id`, `can_escalate`, `escalate_after_hours`, `escalation_role_id`, `required_notes`, `allow_rejection`, `reject_requires_reason`, `created_at`) VALUES
...
INSERT IGNORE INTO `approval_workflows` (`id`, `workflow_name`, `workflow_code`, `description`, `category`, `requires_final_approval`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `bursar_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `is_editable`, `updated_at`) VALUES
...
INSERT IGNORE INTO `bursar_users` (`id`, `email`, `password_hash`, `full_name`, `phone`, `role`, `status`, `last_login`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `chart_of_accounts` (`id`, `account_code`, `account_name`, `account_type`, `sub_type`, `description`, `normal_balance`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `communication_channels` (`id`, `department_code`, `department_name`, `routing_email`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `compliance_requirements` (`id`, `requirement_name`, `description`, `category`, `frequency`, `due_date`, `assigned_role_id`, `assigned_staff_id`, `status`, `evidence_path`, `reviewed_by`, `reviewed_at`, `notes`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cost_centers` (`id`, `cost_center_code`, `cost_center_name`, `department`, `manager_name`, `budget_owner`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `data_ownership_rules` (`id`, `role_id`, `department_code`, `access_level`, `data_category`, `can_export`, `can_delete`, `can_approve`, `is_owner`, `created_at`) VALUES
...
INSERT IGNORE INTO `director_departments` (`id`, `role_id`, `department_name`, `department_code`, `description`, `is_primary`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `document_print_configs` (`id`, `document_type`, `page_size`, `orientation`, `logo_width_px`, `show_logo`, `show_header`, `show_footer`, `footer_text`, `margin_top_mm`, `margin_bottom_mm`, `margin_left_mm`, `margin_right_mm`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `document_settings` (`id`, `setting_key`, `setting_value`, `setting_group`, `setting_type`, `description`, `updated_by`, `updated_at`) VALUES
...
INSERT IGNORE INTO `document_templates` (`id`, `template_name`, `template_type`, `template_content`, `template_variables`, `is_default`, `created_by`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `grade_scales` (`id`, `grade_letter`, `grade_point`, `min_percentage`, `max_percentage`, `grade_description`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `hr_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `is_editable`, `updated_at`) VALUES
...
INSERT IGNORE INTO `hr_users` (`id`, `email`, `password_hash`, `full_name`, `phone`, `role`, `status`, `last_login`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `institutional_alerts` (`id`, `title`, `description`, `alert_title`, `alert_message`, `alert_type`, `priority`, `category`, `department_code`, `source`, `source_url`, `is_auto_generated`, `is_read`, `is_resolved`, `resolved_at`, `resolved_by`, `expires_at`, `created_at`) VALUES
...
INSERT IGNORE INTO `institutional_risks` (`id`, `risk_name`, `risk_title`, `risk_description`, `risk_category`, `likelihood`, `impact`, `mitigation_strategy`, `contingency_plan`, `owner_staff_id`, `status`, `review_date`, `created_at`, `updated_at`, `risk_score`) VALUES
...
INSERT IGNORE INTO `inventory` (`id`, `item_code`, `item_name`, `item_category`, `description`, `department`, `report_to`, `unit_of_measure`, `quantity_on_hand`, `reorder_level`, `unit_cost`, `currency`, `location`, `supplier`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `late_payment_settings` (`id`, `setting_key`, `setting_value`, `description`, `updated_by`, `updated_at`) VALUES
...
INSERT IGNORE INTO `leave_types` (`id`, `leave_type_name`, `leave_type_code`, `days_per_year`, `is_paid`, `requires_approval`, `description`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `medicine_stock` (`id`, `medicine_code`, `medicine_name`, `generic_name`, `category`, `dosage_form`, `strength`, `manufacturer`, `supplier`, `quantity_in_stock`, `unit`, `reorder_level`, `unit_cost`, `selling_price`, `currency`, `batch_number`, `expiry_date`, `storage_location`, `requires_prescription`, `instructions`, `side_effects`, `status`, `last_restocked`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `official_duties` (`id`, `role_id`, `duty_title`, `duty_icon`, `sort_order`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `payment_methods` (`id`, `method_name`, `description`, `requires_verification`, `is_active`, `created_at`) VALUES
...
INSERT IGNORE INTO `payment_routes` (`id`, `payment_type`, `notify_role_id`, `notify_role_name`, `notify_order`, `is_active`, `created_at`) VALUES
...
INSERT IGNORE INTO `penalty_configurations` (`id`, `penalty_name`, `penalty_type`, `calculation_method`, `fixed_amount`, `percentage_value`, `daily_rate`, `grace_days`, `max_penalty_amount`, `applicable_to`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `performance_indicators` (`id`, `indicator_code`, `indicator_name`, `indicator_category`, `description`, `measurement_type`, `target_value`, `weight`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `receipt_templates` (`id`, `template_name`, `template_type`, `template_content`, `template_variables`, `is_active`, `created_by`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `registrar_academic_calendar` (`id`, `academic_year`, `semester`, `semester_start`, `semester_end`, `registration_start`, `registration_end`, `add_drop_deadline`, `withdrawal_deadline`, `exam_start`, `exam_end`, `result_publication_date`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `registrar_settings` (`id`, `setting_key`, `setting_value`, `setting_group`, `description`, `updated_by`, `updated_at`) VALUES
...
INSERT IGNORE INTO `requirement_items` (`id`, `item_name`, `item_category`, `description`, `is_mandatory`, `display_order`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `sickbay_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES
...
INSERT IGNORE INTO `sickness_directory` (`id`, `sickness_code`, `sickness_name`, `category`, `common_symptoms`, `description`, `is_contagious`, `typical_treatment`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `staff_activity_log` (`id`, `staff_id`, `activity_type`, `activity_description`, `related_table`, `related_id`, `module_accessed`, `record_id`, `ip_address`, `user_agent`, `created_at`) VALUES
...
INSERT IGNORE INTO `staff_categories` (`id`, `category_name`, `category_code`, `description`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `staff_departments` (`id`, `department_name`, `department_code`, `description`, `head_of_department_id`, `parent_department_id`, `department_level`, `budget`, `location`, `contact_email`, `contact_phone`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `staff_login_sessions` (`id`, `staff_id`, `session_token`, `device_info`, `browser_info`, `ip_address`, `user_agent`, `is_active`, `created_at`, `last_activity`, `expires_at`) VALUES
...
INSERT IGNORE INTO `staff_permissions` (`id`, `staff_id`, `module`, `permission_level`, `granted_by`, `granted_at`, `expires_at`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `staff_roles` (`id`, `role_name`, `role_description`, `role_level`, `dashboard_path`, `permissions`, `created_at`, `updated_at`, `hierarchy_level`, `reporting_to_role_id`, `can_approve_level`, `is_executive`) VALUES
...
INSERT IGNORE INTO `store_categories` (`id`, `category_name`, `description`, `icon`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `store_inventory` (`id`, `category_id`, `item_name`, `description`, `quantity`, `unit`, `reorder_level`, `unit_price`, `location`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `store_inventory_transactions` (`id`, `item_id`, `transaction_type`, `quantity`, `quantity_before`, `quantity_after`, `reference_type`, `reference_id`, `reason`, `created_by`, `created_at`) VALUES
...
--
-- Table structure for table `submission_routes`
--
-- Creation: Jun 18, 2026 at 06:27 AM
--

CREATE TABLE IF NOT EXISTS `submission_routes` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `submission_routes`
--

INSERT IGNORE INTO `submission_routes` (`id`, `submission_type`, `route_to_role_id`, `route_to_role_name`, `route_order`, `notify_via`, `is_active`, `created_at`) VALUES
(1, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:27:20'),
(2, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:27:20'),
(3, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:27:20'),
(4, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:27:20'),
(5, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:27:20'),
(6, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:27:20'),
(7, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:27:20'),
(8, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:27:20'),
(9, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:29:13'),
(10, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:29:13'),
(11, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:29:13'),
(12, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:29:13'),
(13, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:29:13'),
(14, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:29:13'),
(15, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:29:13'),
(16, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:29:13'),
(17, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:33:41'),
(18, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:33:41'),
(19, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:33:41'),
(20, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:33:41'),
(21, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:33:41'),
(22, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:41'),
(23, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:41'),
(24, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:41'),
(25, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:33:59'),
(26, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:33:59'),
(27, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:33:59'),
(28, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:33:59'),
(29, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:33:59'),
(30, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:59'),
(31, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:59'),
(32, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:33:59'),
(33, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:34:13'),
(34, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:34:13'),
(35, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:34:13'),
(36, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:34:13'),
(37, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:34:13'),
(38, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:13'),
(39, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:13'),
(40, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:13'),
(41, 'application', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:34:27'),
(42, 'application', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:34:27'),
(43, 'volunteer', 27, 'Director Admissions', 1, 'both', 1, '2026-06-18 06:34:27'),
(44, 'volunteer', 22, 'Secretary', 2, 'both', 1, '2026-06-18 06:34:27'),
(45, 'donation', 5, 'Director Finance', 1, 'both', 1, '2026-06-18 06:34:27'),
(46, 'contact', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:27'),
(47, 'feedback', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:27'),
(48, 'complaint', 1, 'Director General', 1, 'both', 1, '2026-06-18 06:34:27');
...
INSERT IGNORE INTO `system_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `category`, `is_public`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `transcript_generation_log` (
  `id` int NOT NULL,
  `transcript_number` varchar(50) NOT NULL,
  `student_id` int NOT NULL,
  `requested_by` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ura_reporting` (
  `id` int NOT NULL,
  `report_code` varchar(50) NOT NULL,
...
-- Creation: Jun 19, 2026 at 06:36 AM
--

CREATE OR REPLACE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `view_program_grouping`  AS SELECT `academic_course_catalog`.`program_code` AS `department`, `academic_course_catalog`.`course_code` AS `course_code`, `academic_course_catalog`.`course_title` AS `course_name`, `academic_course_catalog`.`credits` AS `credit_hours`, `academic_course_catalog`.`year_of_study` AS `course_level` FROM `academic_course_catalog` WHERE ((`academic_course_catalog`.`course_title` is not null) AND (`academic_course_catalog`.`course_title` <> '')) ORDER BY `academic_course_catalog`.`program_code` ASC, `academic_course_catalog`.`course_title` ASC ;
...
CREATE OR REPLACE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `view_student_grouping`  AS SELECT `igangaschoolofl_students_db`.`students`.`course` AS `program`, `igangaschoolofl_students_db`.`students`.`current_year` AS `year_of_study`, `igangaschoolofl_students_db`.`students`.`status` AS `status`, `igangaschoolofl_students_db`.`students`.`set_name` AS `set_name`, `igangaschoolofl_students_db`.`students`.`current_semester` AS `semester`, count(0) AS `student_count` FROM `igangaschoolofl_students_db`.`students` WHERE ((`igangaschoolofl_students_db`.`students`.`full_name` is not null) AND (`igangaschoolofl_students_db`.`students`.`full_name` <> '') AND (length(`igangaschoolofl_students_db`.`students`.`full_name`) > 3) AND (not((`igangaschoolofl_students_db`.`students`.`full_name` like '%MINISTRY%'))) AND (not((`igangaschoolofl_students_db`.`students`.`full_name` like '%ACCOUNTABILITY%'))) AND (not((`igangaschoolofl_students_db`.`students`.`full_name` like '%VERIFICATION%'))) AND (not((`igangaschoolofl_students_db`.`students`.`full_name` like '%HEALTH EDUCATION%'))) AND (not((`igangaschoolofl_students_db`.`students`.`full_name` like '%……………………………………………………%')))) GROUP BY `igangaschoolofl_students_db`.`students`.`course`, `igangaschoolofl_students_db`.`students`.`current_year`, `igangaschoolofl_students_db`.`students`.`status`, `igangaschoolofl_students_db`.`students`.`set_name`, `igangaschoolofl_students_db`.`students`.`current_semester` ORDER BY `igangaschoolofl_students_db`.`students`.`course` ASC, `igangaschoolofl_students_db`.`students`.`current_year` ASC, `igangaschoolofl_students_db`.`students`.`status` ASC ;
...
ALTER TABLE `student_sick_leave`
  ...
  ADD KEY `idx_ssl_deleted` (`is_deleted`);
...
--
-- Indexes for table `submission_routes`
--
ALTER TABLE `submission_routes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_type` (`submission_type`),
  ADD KEY `idx_role` (`route_to_role_id`);
...
--
-- AUTO_INCREMENT for table `submission_routes`
--
ALTER TABLE `submission_routes`
