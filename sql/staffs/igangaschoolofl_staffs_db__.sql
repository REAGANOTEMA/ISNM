...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4e6374423d332f6e7757715356717c38">
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_audit_trail` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bank_accounts` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_bank_reconciliation` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_cashbook` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_chart_of_accounts` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_discounts` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_general_ledger` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_indexes` ()   BEGIN
    -- bursar_discounts
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_payment_verification` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_penalty_config` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_scholarships` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_sponsorships` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_tax_filings` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_tax_periods` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_vat_reports` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_bursar_withholding_tax` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_expenses` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_fee_adjustments` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_late_payment_settings` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_payment_approvals` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_store_orders` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_ura_reports` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fix_payroll_approvals` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fix_payslips` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fix_payslips_indexes` ()   BEGIN
