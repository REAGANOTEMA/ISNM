...
if ($stuConn) {
    ...
    $stuConn->query("CREATE TABLE IF NOT EXISTS financial_notices (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(300) DEFAULT '', subject VARCHAR(300) DEFAULT '', message TEXT, content TEXT, audience VARCHAR(100) DEFAULT 'all', published_by VARCHAR(200) DEFAULT '', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
}
if ($staffConn) {
    $staffConn->query("CREATE TABLE IF NOT EXISTS budgets (id INT AUTO_INCREMENT PRIMARY KEY, budget_name VARCHAR(200) DEFAULT '', total_amount DECIMAL(14,2) DEFAULT 0, fiscal_year VARCHAR(20) DEFAULT '', status VARCHAR(50) DEFAULT 'Draft', created_by INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS payroll_runs (id INT AUTO_INCREMENT PRIMARY KEY, period VARCHAR(20) DEFAULT '', description TEXT, total_gross DECIMAL(14,2) DEFAULT 0, total_deductions DECIMAL(14,2) DEFAULT 0, total_net DECIMAL(14,2) DEFAULT 0, status VARCHAR(50) DEFAULT 'draft', created_by INT DEFAULT 0, run_date DATE DEFAULT NULL, start_date DATE DEFAULT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS payroll_employees (id INT AUTO_INCREMENT PRIMARY KEY, staff_id INT NOT NULL, basic_salary DECIMAL(14,2) DEFAULT 0, payroll_status VARCHAR(50) DEFAULT 'active', status VARCHAR(50) DEFAULT 'active', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, INDEX idx_pe_staff (staff_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS payroll_details (id INT AUTO_INCREMENT PRIMARY KEY, payroll_run_id INT NOT NULL, staff_id INT NOT NULL, basic_salary DECIMAL(14,2) DEFAULT 0, gross_pay DECIMAL(14,2) DEFAULT 0, paye_tax DECIMAL(14,2) DEFAULT 0, nssf_employee DECIMAL(14,2) DEFAULT 0, nssf_employer DECIMAL(14,2) DEFAULT 0, other_deductions DECIMAL(14,2) DEFAULT 0, net_pay DECIMAL(14,2) DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, INDEX idx_pd_run (payroll_run_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS bank_reconciliation (id INT AUTO_INCREMENT PRIMARY KEY, reconciliation_date DATE DEFAULT NULL, bank_balance DECIMAL(14,2) DEFAULT 0, book_balance DECIMAL(14,2) DEFAULT 0, difference DECIMAL(14,2) DEFAULT 0, notes TEXT, status VARCHAR(50) DEFAULT 'pending', reconciled_by INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS chart_of_accounts (id INT AUTO_INCREMENT PRIMARY KEY, code VARCHAR(20) DEFAULT '', name VARCHAR(200) DEFAULT '', type VARCHAR(50) DEFAULT '', description TEXT, status VARCHAR(50) DEFAULT 'Active', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE KEY uq_coa_code (code)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS bursar_withholding_tax (id INT AUTO_INCREMENT PRIMARY KEY, tax_date DATE DEFAULT NULL, payee_name VARCHAR(200) DEFAULT '', description TEXT, gross_amount DECIMAL(14,2) DEFAULT 0, wht_rate DECIMAL(5,2) DEFAULT 0, wht_amount DECIMAL(14,2) DEFAULT 0, status VARCHAR(50) DEFAULT 'active', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS bursar_vat_reports (id INT AUTO_INCREMENT PRIMARY KEY, period_start DATE DEFAULT NULL, period_end DATE DEFAULT NULL, net_vat DECIMAL(14,2) DEFAULT 0, output_vat DECIMAL(14,2) DEFAULT 0, status VARCHAR(50) DEFAULT 'draft', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS assets (id INT AUTO_INCREMENT PRIMARY KEY, asset_name VARCHAR(200) DEFAULT '', purchase_cost DECIMAL(14,2) DEFAULT 0, value DECIMAL(14,2) DEFAULT 0, depreciation_value DECIMAL(14,2) DEFAULT 0, category VARCHAR(100) DEFAULT '', purchase_date DATE DEFAULT NULL, useful_life_years INT DEFAULT 5, salvage_value DECIMAL(14,2) DEFAULT 0, status VARCHAR(50) DEFAULT 'new', created_by INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $staffConn->query("CREATE TABLE IF NOT EXISTS inventory_items (id INT AUTO_INCREMENT PRIMARY KEY, item_name VARCHAR(200) DEFAULT '', category VARCHAR(100) DEFAULT '', quantity INT DEFAULT 0, unit VARCHAR(50) DEFAULT 'pcs', unit_cost DECIMAL(14,2) DEFAULT 0, reorder_level INT DEFAULT 0, location VARCHAR(200) DEFAULT '', status VARCHAR(50) DEFAULT 'in_stock', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
}
