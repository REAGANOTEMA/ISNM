...
if ($conn) {
    ...
    $conn->query("CREATE TABLE IF NOT EXISTS `{$staff_db}`.`course_catalog` (id INT AUTO_INCREMENT PRIMARY KEY, course_code VARCHAR(50) NOT NULL, course_name VARCHAR(300) NOT NULL, program VARCHAR(200) DEFAULT '', level VARCHAR(50) DEFAULT '', semester VARCHAR(100) DEFAULT '', is_compulsory TINYINT(1) DEFAULT 1, status VARCHAR(50) DEFAULT 'Active', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    ...
    $conn->query("CREATE TABLE IF NOT EXISTS `{$staff_db}`.`course_registrations` (id INT AUTO_INCREMENT PRIMARY KEY, student_id INT NOT NULL, course_code VARCHAR(50) DEFAULT '', course_id INT DEFAULT 0, academic_year VARCHAR(20) DEFAULT NULL, semester VARCHAR(100) DEFAULT NULL, registration_status VARCHAR(50) DEFAULT 'Registered', status VARCHAR(50) DEFAULT 'Registered', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, KEY idx_student (student_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $conn->query("CREATE TABLE IF NOT EXISTS `{$staff_db}`.`assessment_scores` (id INT AUTO_INCREMENT PRIMARY KEY, examination_session_id INT DEFAULT 0, student_id INT NOT NULL, score DECIMAL(8,2) DEFAULT 0, max_score DECIMAL(8,2) DEFAULT 100, entered_by INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, KEY idx_student (student_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
}
