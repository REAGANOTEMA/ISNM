...
if ($staffDb) {
    try {
        ...
        $r = $staffDb->query("SELECT d.*, CONCAT(s.first_name,' ',s.last_name) as student_name FROM disciplinary_records d LEFT JOIN students s ON d.student_id=s.student_id ORDER BY d.date DESC LIMIT 100");
