...
<div class="container" style="margin-left:270px">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-2"><input class="form-control form-control-sm" style="max-width:300px" id="srchIDQY" type="text" placeholder="Search..." onkeyup="filterTable('srchIDQY','tblIDQY')"></div>
<div class="table-responsive">
                <table id="tblIDQY" class="table table-hover">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Template Name</th>
