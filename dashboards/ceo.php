...
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'Chief Executive Officer') {
...
$recent_activities = $conn->query("SELECT * FROM activity_logs ORDER BY created_at DESC LIMIT 10")->fetch_all(MYSQLI_ASSOC);
?>
