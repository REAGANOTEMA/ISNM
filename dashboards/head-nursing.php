...
<div class="nurs-topbar"><div class="nurs-topbar-content"><div class="nurs-topbar-left"><div class="nurs-topbar-title">Head of Nursing</div><div class="nurs-topbar-subtitle">Nursing Department &amp; Clinical Training</div></div><div class="nurs-topbar-right"><span class="nurs-date-badge"><i class="fas fa-calendar-alt me-1"></i><?= date('l, F j, Y') ?></span><a href="#" class="nurs-print-btn" onclick="window.print()"><i class="fas fa-print"></i></a><a href="../auth-handler.php?action=logout" class="nurs-logout-btn"><i class="fas fa-sign-out-alt"></i></a></div></div></div>
