-- Enhanced ISNM School Management System Database
-- Complete with proper login details and all functionalities
...
-- Insert system users with proper login details
INSERT INTO `users` (`user_id`, `username`, `password`, `first_name`, `last_name`, `email`, `phone`, `role`, `department`, `status`) VALUES
('DIR001', 'director', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'John', 'Mugisha', 'director@isnm.ac.ug', '+256771234567', 'Director General', 'Administration', 'active'),
('CEO001', 'ceo', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Sarah', 'Nakato', 'ceo@isnm.ac.ug', '+256772345678', 'Chief Executive Officer', 'Administration', 'active'),
('DIR002', 'academics', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Michael', 'Mukasa', 'academics@isnm.ac.ug', '+256773456789', 'Director Academics', 'Academics', 'active'),
('DIR003', 'ict', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'David', 'Ssekandi', 'ict@isnm.ac.ug', '+256774567890', 'Director ICT', 'ICT', 'active'),
('DIR004', 'finance', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Grace', 'Namulinda', 'finance@isnm.ac.ug', '+256775678901', 'Director Finance', 'Finance', 'active'),
('PRN001', 'principal', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Peter', 'Lutaaya', 'principal@isnm.ac.ug', '+256776789012', 'School Principal', 'Administration', 'active'),
('SEC001', 'secretary', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Joy', 'Nabwire', 'secretary@isnm.ac.ug', '+256777890123', 'School Secretary', 'Administration', 'active'),
('REG001', 'registrar', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Henry', 'Mugisha', 'registrar@isnm.ac.ug', '+256778901234', 'Academic Registrar', 'Academics', 'active'),
('BUR001', 'bursar', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Patience', 'Nabasumba', 'bursar@isnm.ac.ug', '+256779012345', 'School Bursar', 'Finance', 'active'),
('HRM001', 'hrmanager', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Robert', 'Ssewanyana', 'hr@isnm.ac.ug', '+256780123456', 'HR Manager', 'HR', 'active');

-- Note: All passwords are 'password' (hashed with bcrypt)
-- Users can login with: username/password combination
...
CREATE PROCEDURE CalculateStudentGPA(IN student_id_param VARCHAR(20), IN academic_year_param VARCHAR(9), IN semester_param INT)
BEGIN
    SELECT 
        SUM(ar.gpa_contribution) / SUM(ar.credits) as semester_gpa,
        SUM(ar.credits) as total_credits
    FROM academic_records ar
    WHERE ar.student_id = student_id_param 
    AND ar.academic_year = academic_year_param 
    AND ar.semester = semester_param;
END //
...
CREATE TRIGGER log_activity_after_student_update
...
BEGIN
    ...
    VALUES (
        ...
        COALESCE(@current_role, 'system'),
        'Student Updated',
        CONCAT('Updated student: ', NEW.student_id, ' - ', NEW.first_name, ' ', NEW.surname),
        'students',
        NEW.student_id,
        NOW()
    );
...
SELECT 'Enhanced ISNM School Management System Database Setup Complete!' as status;
