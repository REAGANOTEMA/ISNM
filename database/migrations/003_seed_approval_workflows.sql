...
-- Insert stages for ICT Request workflow (2-stage: Dept Head -> DG)
-- First find the ICT workflow ID
SET @ict_wf = (SELECT id FROM igangaschoolofl_staffs_db.approval_workflows WHERE workflow_name = 'ICT Request' LIMIT 1);

INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@ict_wf, 'Department Head Review', 1, NULL, 3),
(@ict_wf, 'Director General Final Approval', 2, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@gen_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@hr_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@fin_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@acad_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@adm_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@lib_wf, 'Director General Approval', 1, NULL, 1);
...
INSERT IGNORE INTO igangaschoolofl_staffs_db.approval_stages (workflow_id, stage_name, stage_order, assigned_role_id, required_hierarchy_level) VALUES
(@store_wf, 'Director General Approval', 1, NULL, 1);
