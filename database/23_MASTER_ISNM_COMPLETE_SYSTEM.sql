-- =====================================================
-- ISNM SCHOOL MANAGEMENT SYSTEM - MASTER COMPLETE SYSTEM
-- Database: isnm_db
-- This is the master SQL file that consolidates all system components
-- =====================================================
...
BEGIN
    ...
    ELSE
        ...
        ELSE -- Staff login
            ...
            IF v_user_id IS NOT NULL AND password_verify(p_password, v_password_hash) THEN
...
GRANT EXECUTE ON PROCEDURE authenticate_user TO 'root'@'localhost';
GRANT EXECUTE ON PROCEDURE record_failed_attempt TO 'root'@'localhost';
GRANT EXECUTE ON PROCEDURE create_user_session TO 'root'@'localhost';
GRANT EXECUTE ON PROCEDURE get_student_dashboard_data TO 'root'@'localhost';
GRANT EXECUTE ON PROCEDURE get_staff_dashboard_data TO 'root'@'localhost';
...
-- =====================================================
SELECT 'ISNM Master Complete System Setup Complete!' as status,
