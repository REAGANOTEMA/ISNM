...
// Check if user is authenticated and has permission to create staff accounts
...
$staffRoles = [
    ...
    'Head Nursing' => 'head-nursing',
    'Head Midwifery' => 'head-midwifery',
    'Matron' => 'matrons',
    'Warden' => 'wardens',
    'Sickbay' => 'sickbay',
    'Driver' => 'drivers',
...
<head>
    ...
    <title>Create Staff Account - ISNM</title>
...
<body>
    <div class="container">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Register a new staff member for Iganga School of Nursing and Midwifery</p>
            </div>
            ...
            <div class="form-content">
                ...
                <div class="permission-notice">
                    ...
                    <strong>Permission Granted:</strong> You are authorized to create staff accounts as <?php echo htmlspecialchars($currentUser['role']); ?>
                </div>
                ...
                <form method="POST" action="create-staff.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">Enter the complete name as it should appear on official documents</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">This will be used for login and official communications</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <select class="form-select" id="role" name="role" required>
                                ...
                                <?php foreach ($staffRoles as $displayName => $value): ?>
                        ...
                        <div class="help-text">Select the appropriate role for this staff member</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">Minimum 8 characters. Include uppercase, lowercase, numbers, and symbols.</div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (strength < 3) {
                e.preventDefault();
                alert('Password is too weak. Please include uppercase, lowercase, numbers, and symbols');
                return;
            }
            ...
            // Confirm submission
            if (!confirm('Are you sure you want to create this staff account?')) {
                e.preventDefault();
            }
        });
