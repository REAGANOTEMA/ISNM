<?php $pageTitle = 'Contact Bursar\'s Office'; include_once 'shared/_header.php'; ?>
<style>
...
.dept-card .dept-icon { width: 72px; height: 72px; border-radius: 50%; background: linear-gradient(135deg,#d97706,#b45309); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 30px; margin: 0 auto 16px; }
...
.dept-details i { width: 20px; color: #d97706; }
...
<div class="dept-card">
<div class="dept-icon"><i class="fas fa-money-bill-wave"></i></div>
<h2>Bursar's Office</h2>
<p class="dept-subtitle">Fee payments, invoices, financial inquiries, and student billing</p>
<div class="contact-btn-group">
<a href="mailto:bursar@igangaschoolofnursingandmidwifery.ac.ug" class="contact-btn email"><i class="fas fa-envelope"></i> bursar@igangaschool...</a>
<a href="https://wa.me/256772514889?text=Hello%20Bursar%20Office" target="_blank" class="contact-btn whatsapp"><i class="fab fa-whatsapp"></i> WhatsApp Bursar</a>
<a href="tel:+256772514889" class="contact-btn call"><i class="fas fa-phone"></i> Call Bursar</a>
</div>
<div class="dept-details">
<h4><i class="fas fa-info-circle me-2"></i>About the Bursar's Office</h4>
<p><i class="fas fa-check-circle me-2"></i> We handle all financial matters including fee payments, invoices, receipts, and student billing inquiries.</p>
<p><i class="fas fa-clock me-2"></i> Office Hours: Mon-Fri, 8:00 AM - 4:00 PM</p>
<p><i class="fas fa-map-marker-alt me-2"></i> Located at Finance Block, ISNM Main Campus</p>
</div>
</div>
</div>
