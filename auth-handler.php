        ...
        if ($result !== null && $result['success']) {
            ...
            if (!empty($_SESSION['login_redirect_url'])) {
                ...
                $allowed = [
                    ...
                    'dashboards/senior-lecturers.php',
                    'dashboards/student-management.php',
                    'dashboards/student-records.php',
                    'dashboards/student-discipline.php',
                    'dashboards/student-attendance.php',
                    'dashboards/student-announcements.php',
                    'dashboards/student-requests-desk.php',
                    'dashboards/student-downloads.php',
                    'dashboards/student-add.php',
                    'dashboards/student-library.php',
                    'dashboards/non-teaching-staff.php',
                    'dashboards/staff-attendance.php',
                    'dashboards/staff-directory.php',
                    'dashboards/staff-disciplinary.php',
                    'dashboards/events-manager.php',
                    'dashboards/alumni-manager.php',
                    'dashboards/timetable.php',
                    'dashboards/exams-results.php',
                    'dashboards/grade-scales.php',
                    'dashboards/course-registration.php',
                    'dashboards/donation-tracking.php',
                    'dashboards/portal-messages.php',
                    'dashboards/recycle_bin.php',
                ];
