    ...
    <section class="hero-header">
      ...
      <div class="container">
        <div class="hero-content">
          <div class="hero-text">
            <h1 class="hero-title animate-fade-in">School History</h1>
            <p class="hero-subtitle animate-slide-up">Our Journey of Excellence in Healthcare Education</p>
      ...
      <div class="container">
        ...
        <div class="achievements-grid">
          ...
          <div class="achievement-card animate-fade-in" style="animation-delay: 0.6s;">
            ...
            <p>Acquired over 12 acres of registered/leased land for future development</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="future-content">
          <div class="future-plans animate-fade-in">
            ...
            <ul class="plans-list">
              <li>Mobilize more resources from within and without</li>
              <li>Improve working conditions for teaching and non-teaching staff</li>
              <li>Construct administration block, classroom block, boys' hostel</li>
              <li>Procure more reference books for the library</li>
              <li>Continue supporting clinical instructors for Tutors' Training</li>
            </ul>
          </div>
          ...
          <div class="future-plans animate-slide-up" style="animation-delay: 0.3s;">
            ...
            <ul class="plans-list">
              <li>Establish a fully registered Computer Laboratory</li>
              <li>Improve institutional capacity through specialized departments</li>
              <li>Twinning with other schools for academic exchange</li>
              <li>Construct a hospital for community and student practicum</li>
              <li>Appeal for government support through delegated funds</li>
            </ul>
          </div>
        </div>
      </div>
