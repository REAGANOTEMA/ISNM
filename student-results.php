...
<title>Student Results Portal – ISNM</title>
      ...
      <div class="card dev-card">
        <div class="card-header text-white">
          <div class="d-flex align-items-center gap-3 mb-1">
            ...
            <div>
              <h2 class="mb-1">Student Results Portal</h2>
              <p class="mb-0 opacity-75">Access examination results, transcripts, and academic performance reports</p>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <ul class="feature-list">
            <li><i class="fas fa-graduation-cap text-primary"></i> View semester results and cumulative GPA</li>
            <li><i class="fas fa-download text-success"></i> Download official transcripts in PDF format</li>
            <li><i class="fas fa-chart-simple text-warning"></i> Performance analytics and grade distribution</li>
            <li><i class="fas fa-print text-info"></i> Print result slips for each academic period</li>
            <li><i class="fas fa-timeline text-secondary"></i> Track academic progress across all semesters</li>
          </ul>
          <hr class="my-4">
