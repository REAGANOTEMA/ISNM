...
<title>Library Portal – ISNM</title>
      ...
      <div class="card dev-card">
        <div class="card-header text-white">
          <div class="d-flex align-items-center gap-3 mb-1">
            ...
            <div>
              <h2 class="mb-1">Library Portal</h2>
              <p class="mb-0 opacity-75">Search the library catalogue, manage borrowings, and access digital resources</p>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <ul class="feature-list">
            <li><i class="fas fa-search text-primary"></i> Search library catalogue by title, author, or subject</li>
            <li><i class="fas fa-hand-holding-heart text-success"></i> View current borrowings and due dates</li>
            <li><i class="fas fa-clock text-warning"></i> Request book renewals and place holds</li>
            <li><i class="fas fa-globe text-info"></i> Access digital resources and e-books</li>
            <li><i class="fas fa-history text-secondary"></i> View borrowing history and fines</li>
          </ul>
          <hr class="my-4">
