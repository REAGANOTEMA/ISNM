<?php $pageTitle = 'Contact the Principal'; include_once 'shared/_header.php'; ?>
<style>
...
.dept-card .dept-icon { width: 72px; height: 72px; border-radius: 50%; background: linear-gradient(135deg,#7c3aed,#6d28d9); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 30px; margin: 0 auto 16px; }
...
.dept-details i { width: 20px; color: #7c3aed; }
...
<p class="dept-subtitle">Academic leadership, policy matters, and executive communications</p>
<div class="contact-btn-group">
<a href="mailto:principal@igangaschoolofnursingandmidwifery.ac.ug" class="contact-btn email"><i class="fas fa-envelope"></i> principal@igangaschool...</a>
<a href="https://wa.me/256772514889?text=Hello%20Principal%20Office" target="_blank" class="contact-btn whatsapp"><i class="fab fa-whatsapp"></i> WhatsApp Principal</a>
<a href="tel:+256772514889" class="contact-btn call"><i class="fas fa-phone"></i> Call Principal</a>
</div>
<div class="dept-details">
<h4><i class="fas fa-info-circle me-2"></i>About the Principal's Office</h4>
<p><i class="fas fa-check-circle me-2"></i> The Principal oversees all academic and administrative operations. For policy inquiries, partnership proposals, and high-level communications.</p>
<p><i class="fas fa-clock me-2"></i> Appointment required. Office Hours: Mon-Fri, 9:00 AM - 4:00 PM</p>
<p><i class="fas fa-map-marker-alt me-2"></i> Located at Administration Block, ISNM Main Campus</p>
</div>
</div>
</div>
