...
$menuStructure = [
    'director_general' => [
        ...
        ['label' => 'Staff Management', 'icon' => 'people', 'url' => '/dashboards/staff-management.php', 'active' => 'staff-management'],
        ['label' => 'Reports', 'icon' => 'assessment', 'url' => '/dashboards/reports.php', 'active' => 'reports'],
        ['label' => 'Messages', 'icon' => 'mail', 'url' => '/dashboards/messages.php', 'active' => 'messages'],
        ['label' => 'Settings', 'icon' => 'settings', 'url' => '/dashboards/settings.php', 'active' => 'settings'],
    ],
    'director' => [
        ['label' => 'Dashboard', 'icon' => 'dashboard', 'url' => '/dashboards/director.php', 'active' => 'director'],
        ['label' => 'Publish News', 'icon' => 'article', 'url' => '/dashboards/news-management.php', 'active' => 'news-management'],
        ['label' => 'Department', 'icon' => 'domain', 'url' => '/dashboards/department.php', 'active' => 'department'],
        ['label' => 'Reports', 'icon' => 'assessment', 'url' => '/dashboards/reports.php', 'active' => 'reports'],
        ['label' => 'Messages', 'icon' => 'mail', 'url' => '/dashboards/messages.php', 'active' => 'messages'],
    ],
    'bursar' => [
        ['label' => 'Dashboard', 'icon' => 'dashboard', 'url' => '/dashboards/bursar.php', 'active' => 'bursar'],
        ['label' => 'Student Fees', 'icon' => 'money', 'url' => '/dashboards/student-fees.php', 'active' => 'student-fees'],
        ['label' => 'Payments', 'icon' => 'payment', 'url' => '/dashboards/payments.php', 'active' => 'payments'],
        ['label' => 'Reports', 'icon' => 'assessment', 'url' => '/dashboards/reports.php', 'active' => 'reports'],
        ['label' => 'Messages', 'icon' => 'mail', 'url' => '/dashboards/messages.php', 'active' => 'messages'],
    ],
    'admissions' => [
        ['label' => 'Dashboard', 'icon' => 'dashboard', 'url' => '/dashboards/admissions.php', 'active' => 'admissions'],
        ['label' => 'Applications', 'icon' => 'description', 'url' => '/dashboards/applications.php', 'active' => 'applications'],
        ['label' => 'Applicants', 'icon' => 'people', 'url' => '/dashboards/applicants.php', 'active' => 'applicants'],
        ['label' => 'Enrollment', 'icon' => 'school', 'url' => '/dashboards/enrollment.php', 'active' => 'enrollment'],
        ['label' => 'Reports', 'icon' => 'assessment', 'url' => '/dashboards/reports.php', 'active' => 'reports'],
    ],
    'lecturer' => [
        ['label' => 'Dashboard', 'icon' => 'dashboard', 'url' => '/dashboards/lecturer.php', 'active' => 'lecturer'],
        ['label' => 'Classes', 'icon' => 'class', 'url' => '/dashboards/classes.php', 'active' => 'classes'],
        ['label' => 'Grades', 'icon' => 'assessment', 'url' => '/dashboards/grades.php', 'active' => 'grades'],
        ['label' => 'Attendance', 'icon' => 'event_note', 'url' => '/dashboards/attendance.php', 'active' => 'attendance'],
        ['label' => 'Resources', 'icon' => 'folder', 'url' => '/dashboards/resources.php', 'active' => 'resources'],
    ],
];
