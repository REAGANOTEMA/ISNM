    ...
    <div class="dashboard-actions">
        ...
        <div class="profile-dropdown">
            ...
            <div class="profile-menu" id="profileMenu" style="display: none;">
                ...
                <hr class="profile-divider">
                <a href="#" class="profile-menu-item profile-logout" onclick="event.preventDefault();var f=document.createElement('form');f.method='POST';f.action='/logout.php';document.body.appendChild(f);f.submit();">
                    <svg viewBox="0 0 24 24" fill="currentColor">
