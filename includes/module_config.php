    ...
    return [
        ...
        [
            ...
            'children' => [
                ...
                ['title' => '─ Bursar Dashboard ─',  'route' => 'school-bursar.php#home',              'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Fees Management ────', 'route' => 'school-bursar.php#fee_structure',  'roles' => ['bursar','finance','accountant']],
                ['title' => 'Fee Structure',         'route' => 'school-bursar.php#fee_structure',     'roles' => ['bursar','finance','accountant']],
                ['title' => 'Generate Invoice',      'route' => 'school-bursar.php#generate_invoice',  'roles' => ['bursar','finance','accountant']],
                ['title' => 'Student Statement',     'route' => 'school-bursar.php#student_statement', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'Bulk Billing',          'route' => 'school-bursar.php#bulk_billing',      'roles' => ['bursar','finance','accountant']],
                ['title' => 'Fee Adjustments',       'route' => 'school-bursar.php#fee_adjustments',   'roles' => ['bursar','finance','accountant']],
                ['title' => 'Scholarships',          'route' => 'school-bursar.php#scholarships',      'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Payments ────',     'route' => 'school-bursar.php#record_payment',   'roles' => ['bursar','finance','accountant']],
                ['title' => 'Record Payment',        'route' => 'school-bursar.php#record_payment',    'roles' => ['bursar','finance','accountant']],
                ['title' => 'Payment Verification',  'route' => 'school-bursar.php#payment_verification','roles' => ['bursar','finance','accountant']],
                ['title' => 'Receipt Printing',      'route' => 'school-bursar.php#receipt_print',     'roles' => ['bursar','finance','accountant']],
                ['title' => 'Auto-Deductions',       'route' => 'payment-subscriptions.php',           'roles' => ['bursar','finance','accountant']],
                ['title' => 'Proof of Payments',     'route' => 'school-bursar.php#proof_of_payments', 'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Reports ────',      'route' => 'school-bursar.php#financial_reports', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'Financial Reports',     'route' => 'school-bursar.php#financial_reports', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'Daily Collections',     'route' => 'school-bursar.php#daily_collections', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'Debtors List',          'route' => 'school-bursar.php#debtors_list',      'roles' => ['bursar','finance','accountant']],
                ['title' => 'Tax Reports (URA)',     'route' => 'school-bursar.php#tax_reports',       'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Budgets & Expenses ────', 'route' => 'school-bursar.php#budget',      'roles' => ['bursar','finance','accountant']],
                ['title' => 'Budget Management',     'route' => 'school-bursar.php#budget',            'roles' => ['bursar','finance','accountant']],
                ['title' => 'Expenditure Tracking',  'route' => 'school-bursar.php#expenditure',       'roles' => ['bursar','finance','accountant']],
                ['title' => 'Cost Centers',          'route' => 'school-bursar.php#cost_centers',      'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Payroll ────',      'route' => 'school-bursar.php#payroll',           'roles' => ['bursar','finance','accountant']],
                ['title' => 'Payroll Management',    'route' => 'school-bursar.php#payroll',           'roles' => ['bursar','finance','accountant']],
                ['title' => 'Payslips',              'route' => 'school-bursar.php#payslips',          'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Accounting ────',    'route' => 'school-bursar.php#ledger',           'roles' => ['bursar','finance','accountant']],
                ['title' => 'Chart of Accounts',     'route' => 'school-bursar.php#chart_of_accounts', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'General Ledger',        'route' => 'school-bursar.php#ledger',            'roles' => ['bursar','finance','accountant']],
                ['title' => 'Cashbook',              'route' => 'school-bursar.php#cashbook',          'roles' => ['bursar','finance','accountant']],
                ['title' => 'Bank Reconciliation',   'route' => 'school-bursar.php#reconciliation',    'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Assets ────',       'route' => 'school-bursar.php#assets',            'roles' => ['bursar','finance','accountant']],
                ['title' => 'Asset Register',        'route' => 'school-bursar.php#assets',            'roles' => ['bursar','finance','accountant']],
                ['title' => 'Depreciation',          'route' => 'school-bursar.php#depreciation',      'roles' => ['bursar','finance','accountant']],
                ['title' => '──── Communication ────', 'route' => 'school-bursar.php#fee_reminders',   'roles' => ['bursar','finance','accountant']],
                ['title' => 'Fee Reminders',         'route' => 'school-bursar.php#fee_reminders',     'roles' => ['bursar','finance','accountant']],
                ['title' => 'SMS / Email',           'route' => 'school-bursar.php#comms',             'roles' => ['bursar','finance','accountant']],
                ['title' => 'Late Payment Settings',  'route' => 'school-bursar.php#late_payment',     'roles' => ['bursar','finance','accountant']],
                ['title' => 'Penalty Configurations','route' => 'penalty-configurations.php',           'roles' => ['bursar','finance','accountant']],
                ['title' => 'Refunds',               'route' => 'school-bursar.php#refunds',            'roles' => ['bursar','finance','accountant']],
                ['title' => 'Payment Approvals',     'route' => 'school-bursar.php#payment_approvals', 'roles' => ['bursar','finance','accountant']],
                ['title' => 'Financial Clearance',   'route' => 'school-bursar.php#clearance',          'roles' => ['bursar','finance','accountant']],
                ['title' => 'Audit Trail',           'route' => 'school-bursar.php#audit_trail',       'roles' => ['bursar','finance','accountant']],
            ],
        ],
        [
