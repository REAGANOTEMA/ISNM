    ...
    return [
        ...
        [
            ...
            'children' => [
                ...
                ['title' => 'Student Welfare',       'route' => 'matrons.php#students',               'roles' => ['matron','warden']],
                ['title' => 'Counseling Services',   'route' => 'matrons.php#counseling',             'roles' => ['matron','warden']],
                ['title' => 'Health Services',       'route' => 'matrons.php#health',                 'roles' => ['matron','warden','nursing']],
                ['title' => 'Accommodation',          'route' => 'matrons.php#accommodation',          'roles' => ['matron','warden']],
                ['title' => 'Discipline',             'route' => 'matrons.php#discipline',             'roles' => ['matron','warden']],
                ['title' => 'Wardens',               'route' => 'wardens.php',                        'roles' => ['warden','matron']],
                ['title' => 'Student Welfare',       'route' => 'wardens.php#students',               'roles' => ['warden','matron']],
                ['title' => 'Counseling',             'route' => 'wardens.php#counseling',             'roles' => ['warden','matron']],
                ['title' => 'Discipline Management',  'route' => 'wardens.php#discipline',             'roles' => ['warden','matron']],
                ['title' => 'Accommodation',          'route' => 'wardens.php#accommodation',          'roles' => ['warden','matron']],
