...
function performAdvancedSearch($search_term, $filters = []) {
    ...
    $staff_stmt->bind_param("sssss", "%$search_term%", "%$search_term%", "%$search_term%", "%$search_term%", "%$search_term%", "%$search_term%");
    $staff_stmt->execute();
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
        ...
        <div style="padding: 20px; background: #f9f9f9;">
            ...
            <p style="font-size: 12px; color: #666; text-align: center;">
                <em>This is an automated message from the ISNM Enhanced Dashboard System</em><br>
