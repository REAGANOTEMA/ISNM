...
function getRoleOperations(string $role): array {
    ...
    $definitions = [
        ...
        'bursar' => [
            ['label' => 'Dashboard',            'icon'=>'fas fa-chart-pie',    'page'=>'home'],
            ['label' => 'Student Fee Clearance', 'icon'=>'fas fa-clipboard-check', 'page'=>'clearance'],
            ['label' => 'Record Payment',       'icon'=>'fas fa-money-bill',   'page'=>'record_payment'],
            ['label' => 'Generate Invoice',     'icon'=>'fas fa-file-invoice', 'page'=>'generate_invoice'],
            ['label' => 'Student Statement',    'icon'=>'fas fa-file-alt',     'page'=>'student_statement'],
            ['label' => 'Fee Structure',        'icon'=>'fas fa-list',         'page'=>'fee_structure'],
            ...
            ['label' => 'Payslips',             'icon'=>'fas fa-file-invoice', 'page'=>'payslips'],
            ['label' => 'Tax Reports',          'icon'=>'fas fa-calculator',   'page'=>'tax_reports'],
            ['label' => 'Donations',            'icon'=>'fas fa-hand-holding-heart','page'=>'donations'],
            ['label' => 'Procurement',          'icon'=>'fas fa-shopping-cart', 'page'=>'procurement'],
            ['label' => 'Assets',               'icon'=>'fas fa-building',     'page'=>'assets'],
            ['label' => 'Bank Reconciliation',  'icon'=>'fas fa-university',   'page'=>'reconciliation'],
            ['label' => 'Audit Trail',          'icon'=>'fas fa-clipboard-list','page'=>'audit_trail'],
            ['label' => 'Cost Centers',         'icon'=>'fas fa-building',     'page'=>'cost_centers'],
            ['label' => 'Requisitions',         'icon'=>'fas fa-clipboard-list','page'=>'requisitions'],
        ],
        'sickbay' => [
