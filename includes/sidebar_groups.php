...
function getRoleOperations(string $role): array {
    ...
    $definitions = [
        ...
        'academic_registrar' => [
            ...
            ['label' => 'Exam Marks',           'icon'=>'fas fa-pen-fancy',    'page'=>'exam-marks', 'href'=>'exams-results.php'],
            ['label' => 'Grade Scales',         'icon'=>'fas fa-sort-numeric-up','page'=>'grade-scales', 'href'=>'grade-scales.php'],
            ['label' => 'Course Registration',  'icon'=>'fas fa-book-reader',  'page'=>'course-registration', 'href'=>'course-registration.php'],
            ['label' => 'Student Library',      'icon'=>'fas fa-book-open',    'page'=>'student-library', 'href'=>'student-library.php'],
        ],
        'secretary' => [
